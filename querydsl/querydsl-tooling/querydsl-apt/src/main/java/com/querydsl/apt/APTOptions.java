...
public final class APTOptions {
  ...
  public static final String FLUENTQ_CREATE_DEFAULT_VARIABLE = "com.querydsl.createDefaultVariable";

  /** set the prefix for query types (default: Q) */
  public static final String FLUENTQ_PREFIX = "com.querydsl.prefix";

  /** set a suffix for query types (default: empty) */
  public static final String FLUENTQ_SUFFIX = "com.querydsl.suffix";

  /** set a suffix for query type packages (default: empty) */
  public static final String FLUENTQ_PACKAGE_SUFFIX = "com.querydsl.packageSuffix";

  /** enable accessors for direct key based map access (default: false) */
  public static final String FLUENTQ_MAP_ACCESSORS = "com.querydsl.mapAccessors";

  /** enable accessors for direct indexed list access (default: false) */
  public static final String FLUENTQ_LIST_ACCESSORS = "com.querydsl.listAccessors";

  /** enable reference field accessors (default: false) */
  public static final String FLUENTQ_ENTITY_ACCESSORS = "com.querydsl.entityAccessors";

  /** Set whether fields are used as metadata source (default: true) */
  public static final String FLUENTQ_USE_FIELDS = "com.querydsl.useFields";

  /** Set whether accessors are used as metadata source (default: true) */
  public static final String FLUENTQ_USE_GETTERS = "com.querydsl.useGetters";

  /** comma separated list of packages to be excluded from code generation (default: none) */
  public static final String FLUENTQ_EXCLUDED_PACKAGES = "com.querydsl.excludedPackages";

  /** comma separated list of class names to be excluded from code generation (default: none) */
  public static final String FLUENTQ_EXCLUDED_CLASSES = "com.querydsl.excludedClasses";

  /** comma separated list of packages to be included into code generation (default: all) */
  public static final String FLUENTQ_INCLUDED_PACKAGES = "com.querydsl.includedPackages";

  /** comma separated list of class names to be included into code generation (default: all) */
  public static final String FLUENTQ_INCLUDED_CLASSES = "com.querydsl.includedClasses";

  /** set whether unknown non-annotated classes should be treated as embeddable (default: false) */
  public static final String FLUENTQ_UNKNOWN_AS_EMBEDDABLE = "com.querydsl.unknownAsEmbeddable";

  /** set the variable name function class */
  public static final String FLUENTQ_VARIABLE_NAME_FUNCTION_CLASS =
      "com.querydsl.variableNameFunctionClass";

  /** set whether info level messages should be written to stdout (default: false) */
  public static final String FLUENTQ_LOG_INFO = "com.querydsl.logInfo";
  ...
  public static final String FLUENTQ_GENERATED_ANNOTATION_CLASS =
      "com.querydsl.generatedAnnotationClass";
