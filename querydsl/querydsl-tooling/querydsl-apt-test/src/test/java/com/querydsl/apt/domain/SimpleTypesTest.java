...
public class SimpleTypesTest extends AbstractTest {
  ...
  public static class CustomComparableNumber extends CustomNumber
      implements Comparable<CustomComparableNumber> {
  ...
  public static class CustomGenericComparableLiteral<C>
      implements Comparable<CustomComparableLiteral> {
