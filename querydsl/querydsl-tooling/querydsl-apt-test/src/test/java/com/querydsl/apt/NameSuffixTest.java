...
public class NameSuffixTest extends AbstractProcessorTest {
  ...
  public void process_all() throws IOException {
    ...
    assertThat(new File("target/suffix/com/querydsl/apt/domain/query2/QAnimalTest_AnimalType.java"))
        .exists();
  }

  @Override
  protected Collection<String> getAPTOptions() {
    return Arrays.asList("-Acom.querydsl.packageSuffix=.query2", "-Acom.querydsl.suffix=Type");
  }
}
