...
public class ExcludedClassesTest extends AbstractProcessorTest {
  ...
  public void process() throws IOException {
    ...
    assertThat(
            new File(
                    "target/excludedClasses/com/querydsl/apt/domain/QArrayTest_ArrayTestEntity.java")
                .exists())
        .isFalse();
  }
  ...
  protected Collection<String> getAPTOptions() {
    return Collections.singletonList(
        "-Acom.querydsl.excludedClasses=com.querydsl.apt.domain.ArrayTest.ArrayTestEntity");
  }
}
