...
/**
 * {@code JTSGeometryPath} extends {@link JTSGeometryExpression} to implement the {@link Path}
 * interface
 *
 * @author tiwe
 * @param <T>
 */
@Deprecated
public class JTSGeometryPath<T extends Geometry> extends JTSGeometryExpression<T>
    implements Path<T> {
