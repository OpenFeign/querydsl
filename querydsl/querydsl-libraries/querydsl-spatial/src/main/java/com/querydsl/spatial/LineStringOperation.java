...
/**
 * {@code LineStringOperation} extends {@link LineStringExpression} to implement the {@link
 * Operation} interface
 *
 * @author tiwe
 * @param <T>
 */
@Deprecated
public class LineStringOperation<T extends LineString> extends LineStringExpression<T>
