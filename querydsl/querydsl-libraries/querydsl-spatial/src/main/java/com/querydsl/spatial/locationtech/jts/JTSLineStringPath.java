...
/**
 * {@code JTSLineStringPath} extends {@link JTSLineStringExpression} to implement the {@link Path}
 * interface
 *
 * @author tiwe
 * @param <T>
 */
@Deprecated
public class JTSLineStringPath<T extends LineString> extends JTSLineStringExpression<T>
    implements Path<T> {
