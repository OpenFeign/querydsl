...
/**
 * {@code PointOperation} extends {@link PointExpression} to implement the {@link Operation}
 * interface
 *
 * @author tiwe
 * @param <T>
...
public class PointOperation<T extends Point> extends PointExpression<T> implements Operation<T> {
  ...
  protected PointOperation(Class<T> type, Operator op, List<Expression<?>> args) {
