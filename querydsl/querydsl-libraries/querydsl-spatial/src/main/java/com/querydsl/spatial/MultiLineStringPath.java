...
/**
 * {@code MultiLineStringPath} extends {@link MultiLineStringExpression} to implement the {@link
 * Path} interface
 *
 * @author tiwe
 * @param <T>
 */
@Deprecated
public class MultiLineStringPath<T extends MultiLineString> extends MultiLineStringExpression<T>
    implements Path<T> {
