...
class OrderedQueryMetadataTest {
  ...
  private Path<Object> x_a =
      ExpressionUtils.path(Object.class, PathMetadataFactory.forProperty(x, "a"));
  private Path<Object> x_a_a =
      ExpressionUtils.path(Object.class, PathMetadataFactory.forProperty(x_a, "a"));
  private Path<Object> x_a_b =
      ExpressionUtils.path(Object.class, PathMetadataFactory.forProperty(x_a, "b"));
  private Path<Object> x_b =
      ExpressionUtils.path(Object.class, PathMetadataFactory.forProperty(x, "a"));
  private Path<Object> y_a =
      ExpressionUtils.path(Object.class, PathMetadataFactory.forProperty(y, "a"));
  private Path<Object> y_b =
      ExpressionUtils.path(Object.class, PathMetadataFactory.forProperty(y, "b"));
