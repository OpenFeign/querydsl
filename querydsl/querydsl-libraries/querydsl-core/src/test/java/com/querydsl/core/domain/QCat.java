...
public class QCat extends EntityPathBase<Cat> {
  ...
  public final ListPath<Cat, QCat> kittens =
      this.<Cat, QCat>createList("kittens", Cat.class, QCat.class, PathInits.DIRECT);

  public final SetPath<Cat, QCat> kittensSet =
      this.<Cat, QCat>createSet("kittensSet", Cat.class, QCat.class, PathInits.DIRECT);
  ...
  public QCat(Class<? extends Cat> type, PathMetadata metadata, PathInits inits) {
    ...
    this.mate =
        inits.isInitialized("mate") ? new QCat(forProperty("mate"), inits.get("mate")) : null;
  }
