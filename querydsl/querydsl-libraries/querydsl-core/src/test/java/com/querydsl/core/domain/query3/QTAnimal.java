...
public class QTAnimal extends EntityPathBase<Animal> {

  @Serial private static final long serialVersionUID = 781156670;

  public static final QTAnimal animal = new QTAnimal("animal");
  ...
  public QTAnimal(String variable) {
    super(Animal.class, forVariable(variable));
  }

  public QTAnimal(BeanPath<? extends Animal> entity) {
