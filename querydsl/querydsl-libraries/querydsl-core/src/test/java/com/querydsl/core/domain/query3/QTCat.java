...
public class QTCat extends EntityPathBase<Cat> {
  ...
  public final ListPath<Cat, QTCat> kittens =
      this.<Cat, QTCat>createList("kittens", Cat.class, QTCat.class, PathInits.DIRECT);

  public final SetPath<Cat, QTCat> kittensSet =
      this.<Cat, QTCat>createSet("kittensSet", Cat.class, QTCat.class, PathInits.DIRECT);
  ...
  public QTCat(Class<? extends Cat> type, PathMetadata metadata, PathInits inits) {
    ...
    this.mate =
        inits.isInitialized("mate") ? new QTCat(forProperty("mate"), inits.get("mate")) : null;
  }
