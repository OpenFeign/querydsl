...
public class BeanPath<T> extends SimpleExpression<T> implements Path<T> {
  ...
  public final <R, C> R accept(Visitor<R, C> v, C context) {
    // mixin is not used here, because subtype instances may have data that needs to be made
    // available
   ...
   */
  @SuppressWarnings("unchecked")
  protected <A, Q extends SimpleExpression<? super A>> CollectionPath<A, Q> createCollection(
   ...
   */
  @SuppressWarnings("unchecked")
  protected <A extends Comparable> ComparablePath<A> createComparable(
   ...
   */
  @SuppressWarnings("unchecked")
  protected <K, V, E extends SimpleExpression<? super V>> MapPath<K, V, E> createMap(
      String property, Class<? super K> key, Class<? super V> value, Class<? super E> queryType) {
   ...
   */
  @SuppressWarnings("unchecked")
  protected <A, E extends SimpleExpression<? super A>> SetPath<A, E> createSet(
      String property, Class<? super A> type, Class<? super E> queryType, PathInits inits) {
