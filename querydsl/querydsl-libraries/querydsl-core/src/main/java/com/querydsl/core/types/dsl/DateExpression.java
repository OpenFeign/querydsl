...
/**
 * {@code DateExpression} represents Date expressions The date representation is compatible with the
 * Gregorian calendar.
 *
...
public abstract class DateExpression<T extends Comparable> extends TemporalExpression<T> {
  ...
  @Nullable private transient volatile DateExpression<T> min, max;
  @Nullable
