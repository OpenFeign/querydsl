...
public final class MathExpressions {
   ...
   *
   * <p>Returns the principal value of the arc cosine of num, expressed in radians.
   *
   * @param num numeric expression
   * @return acos(num)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> acos(
      Expression<A> num) {
   ...
   *
   * <p>Returns the principal value of the arc sine of num, expressed in radians.
   *
   * @param num numeric expression
   * @return asin(num)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> asin(
      Expression<A> num) {
   ...
   *
   * <p>Returns the principal value of the arc tangent of num, expressed in radians.
   *
   * @param num numeric expression
   * @return atan(num)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> atan(
      Expression<A> num) {
   ...
   *
   * <p>Returns the cosine of an angle of num radians.
   *
   * @param num numeric expression
   * @return cos(num)
   */
   ...
   *
   * <p>Returns the hyperbolic cosine of num radians.
   *
   * @param num numeric expression
   * @return cosh(num)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> cosh(
      Expression<A> num) {
   ...
   *
   * <p>Returns the cotangent of num.
   *
   * @param num numeric expression
   * @return cot(num)
   */
   ...
   *
   * <p>Returns the hyperbolic cotangent of num.
   *
   * @param num numeric expression
   * @return coth(num)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> coth(
      Expression<A> num) {
   ...
   * @return deg(num)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> degrees(
      Expression<A> num) {
   ...
   *
   * <p>Returns the base-e exponential function of num, which is e raised to the power num.
   *
   * @param num numeric expression
   * @return exp(num)
   */
   ...
   *
   * <p>Returns the natural logarithm of num.
   *
   * @param num numeric expression
   * @return ln(num)
   */
   ...
   * @return log(num, base)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> log(
      Expression<A> num, int base) {
    return Expressions.numberOperation(
        Double.class, Ops.MathOps.LOG, num, ConstantImpl.create(base));
  }

  /**
   * Create a {@code max(left, right)} expression
   *
   * <p>Return the greater of the given values
   *
   * @return max(left, right)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<A> max(
      Expression<A> left, Expression<A> right) {
   ...
   *
   * <p>Return the smaller of the given values
   *
   * @return min(left, right)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<A> min(
      Expression<A> left, Expression<A> right) {
   ...
   *
   * <p>Returns num raised to the power exponent
   *
   * @param num numeric expression
   * @param exponent exponent
   * @return power(num, exponent)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> power(
      Expression<A> num, int exponent) {
    return Expressions.numberOperation(
        Double.class, Ops.MathOps.POWER, num, ConstantImpl.create(exponent));
  }
   ...
   * @return rad(num)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> radians(
      Expression<A> num) {
   ...
   * @return round(num, s)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<A> round(
      Expression<A> num, int s) {
   ...
   *
   * <p>Returns the positive (+1), zero (0), or negative (-1) sign of num.
   *
   * @param num numeric expression
   * @return sign(num)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Integer> sign(
      Expression<A> num) {
   ...
   *
   * <p>Returns the sine of an angle of num radians.
   *
   * @param num numeric expression
   * @return sin(num)
   */
   ...
   *
   * <p>Returns the hyperbolic sine of num radians.
   *
   * @param num numeric expression
   * @return sinh(num)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> sinh(
      Expression<A> num) {
   ...
   *
   * <p>Returns the tangent of an angle of num radians.
   *
   * @param num numeric expression
   * @return tan(num)
   */
   ...
   *
   * <p>Returns the hyperbolic tangent of num radians.
   *
   * @param num numeric expression
   * @return tanh(num)
   */
  public static <A extends Number & Comparable<?>> NumberExpression<Double> tanh(
      Expression<A> num) {
