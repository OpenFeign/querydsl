...
public class PathBuilder<T> extends EntityPathBase<T> {
   ...
   */
  public PathBuilder(
      Class<? extends T> type, PathMetadata pathMetadata, PathBuilderValidator validator) {
   ...
   * @return property path
   */
  public <A, E extends SimpleExpression<A>> CollectionPath<A, E> getCollection(
      String property, Class<A> type, Class<? super E> queryType) {
   ...
   * @return property path
   */
  public <A, E extends SimpleExpression<A>> ListPath<A, E> getList(
      String property, Class<A> type, Class<? super E> queryType) {
   ...
   * @return property path
   */
  public <K, V> MapPath<K, V, PathBuilder<V>> getMap(
      String property, Class<K> key, Class<V> value) {
   ...
   * @return property path
   */
  public <K, V, E extends SimpleExpression<V>> MapPath<K, V, E> getMap(
      String property, Class<K> key, Class<V> value, Class<? super E> queryType) {
   ...
   * @return property path
   */
  public <A, E extends SimpleExpression<A>> SetPath<A, E> getSet(
      String property, Class<A> type, Class<? super E> queryType) {
