...
/**
 * {@code Template} provides serialization templates for {@link Operation}, {@link
 * TemplateExpression} and {@link Path} serialization
 *
 * @author tiwe
 */
@Immutable
...
public class Template implements Serializable {
  ...
  protected Template(String template, List<Element> elements) {
