...
public interface Fetchable<T> {
   ...
   *
   * <p>Make sure to use {@link #fetch()} instead if you do not rely on the {@link
   ...
   *
   * <p>Use {@link #fetch()} instead if you do not need the total count of rows in the query result.
   *
   * @return results
   * @see #fetch()
   */
   ...
   *
   * <p>Note: not all Querydsl modules might optimize fetchCount using a count query. An
