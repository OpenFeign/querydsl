...
public abstract class BooleanExpression extends LiteralExpression<Boolean> implements Predicate {
  ...
  @Nullable private transient volatile BooleanExpression not;
   ...
   *
   * <p>Returns an intersection of this and the given expression
   *
   ...
   *
   * <p>Returns an intersection of this and the union of the given predicates
   *
   ...
   *
   * <p>Returns a negation of this boolean expression
   *
   * @return !this
   */
  @Override
   ...
   * Create a {@code this || right} expression
   *
   * <p>Returns a union of this and the given expression
   *
   * @param right right hand side of the union
   * @return this || right
   */
   ...
   *
   * <p>Return a union of this and the intersection of the given predicates
   *
