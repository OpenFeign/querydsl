...
/**
 * {@code CollectionExpressionBase} is an abstract base class for {@link CollectionExpression}
 * implementations
 *
 * @author tiwe
...
public abstract class CollectionExpressionBase<T extends Collection<E>, E> extends DslExpression<T>
   ...
   *
   * <p>Evaluates to true, if child is contained in this
   *
   ...
   *
   * <p>Evaluates to true, if this has no elements.
   *
   * @return this.isEmpty()
   */
   ...
   * Create a {@code !this.isEmpty()} expression
   *
   * <p>Evaluates to true, if this has elements
   *
   * @return !this.isEmpty()
   */
   ...
   *
   * <p>Gets the number of elements in this collection
   *
   * @return this.size()
   */
