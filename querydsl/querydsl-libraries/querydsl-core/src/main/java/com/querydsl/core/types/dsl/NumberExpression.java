...
public abstract class NumberExpression<T extends Number & Comparable<?>>
  ...
  private static class Constants {
    private static final NumberExpression<Double> RANDOM =
        Expressions.numberOperation(Double.class, MathOps.RANDOM);
  }
   ...
   *
   * <p>Returns the smaller of the given values
   *
  ...
  public NumberExpression<T> as(String alias) {
    return Expressions.numberOperation(
        getType(), Ops.ALIAS, mixin, ExpressionUtils.path(getType(), alias));
  }
   ...
   *
   * <p>Returns the absolute value of this expression
   *
   * @return abs(this)
   */
   ...
   *
   * <p>Returns the sum of this and right
   *
   ...
   * Create a {@code this + right} expression
   *
   * <p>Get the sum of this and right
   *
   * @param right rhs of expression
   * @return this + right
   */
   ...
   *
   * <p>Get the average value of this expression (aggregation)
   *
   * @return avg(this)
   */
   ...
   *
   * <p>Get the byte expression of this numeric expression
   *
   ...
   *
   * <p>Returns the smallest (closest to negative infinity) {@code double} value that is greater
   ...
   * Create a {@code this / right} expression
   *
   * <p>Get the result of the operation this / right
   *
   * @param right
   * @return this / right
   */
   ...
   *
   * <p>Get the double expression of this numeric expression
   *
   ...
   * Create a {@code cast(this as double)} expression
   *
   * <p>Get the float expression of this numeric expression
   *
   ...
   *
   * <p>Returns the largest (closest to positive infinity) {@code double} value that is less than or
   ...
   */
  public final <A extends Number & Comparable<?>> BooleanExpression between(
      @Nullable A from, @Nullable A to) {
    if (from == null) {
      if (to != null) {
        return loe(to);
      } else {
   ...
   */
  public final <A extends Number & Comparable<?>> BooleanExpression between(
      @Nullable Expression<A> from, @Nullable Expression<A> to) {
    if (from == null) {
      if (to != null) {
   ...
   * @return this not between from and to
   */
  public final <A extends Number & Comparable<?>> BooleanExpression notBetween(
      Expression<A> from, Expression<A> to) {
    return between(from, to).not();
  }
   ...
   *
   * <p>Get the int expression of this numeric expression
   *
   ...
   *
   * <p>Get the long expression of this numeric expression
   *
   ...
   *
   * <p>Get the negation of this expression
   *
   * @return this * -1
   */
   ...
   *
   * <p>Returns the closest {@code int} to this.
   *
   * @return round(this)
   ...
   *
   * <p>Get the short expression of this numeric expression
   *
   ...
   *
   * <p>Get the square root of this numeric expressions
   *
   * @return sqrt(this)
   */
   ...
   * Create a {@code this - right} expression
   *
   * <p>Get the difference of this and right
   *
   * @param right
   * @return this - right
   */
