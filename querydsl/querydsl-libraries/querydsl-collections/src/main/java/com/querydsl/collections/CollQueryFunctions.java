...
public final class CollQueryFunctions {
  ...
  private static final BinaryFunction SUM =
      new BinaryFunction() {
        @Override
  ...
  private static final BinaryFunction MAX =
      new BinaryFunction() {
        @Override
        public Number apply(Number num1, Number num2) {
  ...
  private static final BinaryFunction MIN =
      new BinaryFunction() {
        @Override
        public Number apply(Number num1, Number num2) {
          if (num1.getClass().equals(num2.getClass()) && num1 instanceof Comparable) {
  ...
  public static boolean likeIgnoreCase(String str, String like) {
    ...
    if (pattern.toString().equals(like)) {
      ...
      return Pattern.compile(pattern.toString(), Pattern.CASE_INSENSITIVE).matcher(str).matches();
    }
  }
