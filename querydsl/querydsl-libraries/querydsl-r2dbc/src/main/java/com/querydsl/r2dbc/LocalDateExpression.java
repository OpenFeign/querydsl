...
/**
 * {@code LocalDateExpression} represents LocalDate expressions The date representation is
...
public abstract class LocalDateExpression<T extends Comparable> extends TemporalExpression<T> {
  ...
  private static class Constants {
    private static final LocalDateExpression<LocalDate> CURRENT_DATE =
        currentLocalDate(LocalDate.class);
  }
  ...
  @Nullable private transient volatile LocalDateExpression<T> min, max;
  @Nullable
