...
/**
 * {@code LocalDateTemplate} defines custom LocalDate expressions
 *
 * @param <T> expression type
 * @author mc_fish
 */
@Deprecated
public class LocalDateTemplate<T extends Comparable<?>> extends LocalDateExpression<T>
  ...
  protected LocalDateTemplate(TemplateExpressionImpl<T> mixin) {
    super(mixin);
    this.templateMixin = mixin;
  }

  protected LocalDateTemplate(Class<? extends T> type, Template template, List<?> args) {
