...
/**
 * {@code LocalDateTimeTemplate} defines custom LocalDateTime expressions
 *
 * @param <T> expression type
 * @author mc_fish
 */
@Deprecated
public class LocalDateTimeTemplate<T extends Comparable<?>> extends LocalDateTimeExpression<T>
  ...
  protected LocalDateTimeTemplate(TemplateExpressionImpl<T> mixin) {
    super(mixin);
