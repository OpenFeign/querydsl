...
public class DerbyTemplates extends SQLTemplates {
  ...
  public DerbyTemplates(char escape, boolean quote) {
    ...
    add(
        Ops.DateTimeOps.TRUNC_YEAR,
        "timestamp(substr(cast({0} as char(30)),1,4)||'-01-01 00:00:00')");
    add(
        Ops.DateTimeOps.TRUNC_MONTH,
        "timestamp(substr(cast({0} as char(30)),1,7)||'-01 00:00:00')");
    // TODO weeks
  ...
  public String serialize(String literal, int jdbcType) {
    return switch (jdbcType) {
      case Types.BOOLEAN -> "1".equals(literal) ? "true" : "false";
