 ...
 * {@link SQLDetailedListener} callback method
 */
@Deprecated
public interface SQLListenerContext {
  /**
   * The context getData is a general purpose place that listeners can place objects. It allows
   * listeners to pass context between themselves during callbacks.
   *
   * <p>
   *
  ...
  /**
   * The context setData is a general purpose place that listeners can place objects. It allows
   * listeners to pass context between themselves during callbacks.
   *
   * <p>A good time to place objects into the context is during {@link
   * com.querydsl.sql.SQLDetailedListener#start(SQLListenerContext)} and then access if after that.
   *
   ...
   *
   * <p>NOTE : This can be null depending on the stage of the query execution
   *
   * @return the underlying sql or first in a batch query
   */
  String getSQL();
   ...
   *
   * <p>NOTE : This can be empty depending on the stage of the query execution
   *
   * @return the underlying sql collection if the query is a batch query
   */
   ...
   *
   * <p>NOTE : This can be null depending on whether an exception occurred
   *
   * @return the underlying exception that has happened during query execution
   */
