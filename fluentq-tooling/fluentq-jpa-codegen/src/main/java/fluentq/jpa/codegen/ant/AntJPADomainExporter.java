...
import fluentq.jpa.codegen.JPADomainExporter;
...
/**
 * {@code AntJPADomainExporter} exports JPA 2 metamodels to FluentQ expression types
 *
 * @author 200003548
 */
public class AntJPADomainExporter {
  ...
  /**
   * Exports the named persistence unit's metamodel to FluentQ query types. Expects to be called by
  ...
  public void execute() {
    ...
    // Now we can get the persistence unit's metamodel and export it to FluentQ query types.
