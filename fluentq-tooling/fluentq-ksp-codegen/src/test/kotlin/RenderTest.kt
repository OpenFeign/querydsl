...
import fluentq.ksp.codegen.QProperty
import fluentq.ksp.codegen.QPropertyType
import fluentq.ksp.codegen.QueryModel
import fluentq.ksp.codegen.QueryModelRenderer
import fluentq.ksp.codegen.QueryModelType
import fluentq.ksp.codegen.SimpleType
...
class RenderTest {
    ...
    fun propertyTypes() {
        ...
        code.assertContainAll("""
            val a: fluentq.core.types.dsl.BooleanPath = createBoolean("a")
            val b: fluentq.core.types.dsl.StringPath = createString("b")
            val c: fluentq.core.types.dsl.DatePath<java.util.Date> = createDate("c", java.util.Date::class.java)
            val d: fluentq.core.types.dsl.EnumPath<SampleEnum> = createEnum("d", SampleEnum::class.java)
            val e: fluentq.core.types.dsl.DateTimePath<java.util.Date> = createDateTime("e", java.util.Date::class.java)
            val f: fluentq.core.types.dsl.NumberPath<kotlin.Int> = createNumber("f", kotlin.Int::class.javaObjectType)
            val g: fluentq.core.types.dsl.TimePath<java.sql.Time> = createTime("g", java.sql.Time::class.java)
            val h: fluentq.core.types.dsl.SimplePath<kotlin.Any> = createSimple("h", kotlin.Any::class.java)
        """.trimIndent())
    }
    ...
    fun superclass() {
        ...
        val code = typeSpec.toString()
        code.assertCompiles()
        code.assertContains("class QCat : fluentq.core.types.dsl.EntityPathBase<Cat>")
    ...
    fun genericTypeArgs() {
        ...
        code.assertCompiles()
        code.assertLines("""
            @fluentq.core.annotations.Generated
            public class QArticle : fluentq.core.types.dsl.EntityPathBase<Article<*>> {
                public constructor(path: fluentq.core.types.Path<out Article<*>>) : super(path.type, path.metadata)
                
                public constructor(metadata: fluentq.core.types.PathMetadata) : super(Article::class.java, metadata)
                
                public constructor(variable: kotlin.String) : super(Article::class.java, fluentq.core.types.PathMetadataFactory.forVariable(variable))
                
                public constructor(type: java.lang.Class<out Article<*>>, metadata: fluentq.core.types.PathMetadata) : super(type, metadata)
    ...
    fun inheritSuperProperties() {
        ...
        val code = typeSpec.toString()
        code.assertCompiles()
        code.assertContainLines("@kotlin.jvm.JvmField public val hasTail: fluentq.core.types.dsl.BooleanPath = _super.hasTail")
    }
    ...
    fun setCollection() {
        ...
        code.assertCompiles()
        code.assertContains("""
            val features: fluentq.core.types.dsl.SetPath<kotlin.String, fluentq.core.types.dsl.StringPath> = createSet("features", kotlin.String::class.java, fluentq.core.types.dsl.StringPath::class.java, null)
        """.trimIndent())
    }
    ...
    fun queryProjection() {
        ...
        code.assertContainAll("""
            public class QCatDTO(
              id: fluentq.core.types.Expression<kotlin.Int>,
              name: fluentq.core.types.Expression<kotlin.String>,
            ) : fluentq.core.types.ConstructorExpression<CatDTO>(CatDTO::class.java, arrayOf(kotlin.Int::class.java, kotlin.String::class.java), id, name)
        """.trimIndent())
    }
    ...
    fun innerClassNaming() {
        ...
        code.assertContains("val innerProperty: fluentq.core.types.dsl.StringPath = createString(\"innerProperty\")")
    }
	...
	fun geometryTypeRendering() {
		...
		val code = typeSpec.toString()
		code.assertContains("""
			public val geometry: fluentq.spatial.locationtech.jts.JTSGeometryPath<org.locationtech.jts.geom.Geometry> = fluentq.spatial.locationtech.jts.JTSGeometryPath(forProperty("geometry"))
		""".trimIndent())
	}
}
