import fluentq.ksp.codegen.QueryDslProcessorProvider
...
class KspProcessorIntegrationTest {
    ...
    fun entityWithCollectionProperty_doesNotCrashOnParameterizedSupertype() {
        ...
        // arguments"). See OpenFeign/fluentq#1688.
        val source = SourceFile.kotlin(
            "Foo.kt",
            """
            package test
    ...
    fun bidirectionalEntities_loadConcurrentlyWithoutDeadlock() {
        ...
        // OpenFeign/fluentq#1739 for the APT-side compile-time detector.
    ...
    fun referencedClassWithSameSimpleNameAnnotation_isNotMistakenForJpaEntity() {
        ...
        // from a JPA entity would be misclassified as a FluentQ entity and
        ...
        // Helper must NOT be treated as a FluentQ entity (no QHelper reference).
    ...
    fun customComparableWrapper_emitsComparablePath() {
        // A custom Comparable<X> wrapper (typed-value-fluentq-style) — declaration
