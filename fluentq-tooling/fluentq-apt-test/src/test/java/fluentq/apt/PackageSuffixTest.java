...
public class PackageSuffixTest extends AbstractProcessorTest {
  ...
  public void process_all() throws IOException {
    ...
    // default Processor
    process(FluentQAnnotationProcessor.class, classes, "packageSuffix");

    assertThat(new File("target/packageSuffix/fluentq/apt/domain/query/QAnimalTest_Animal.java"))
        .exists();
  }

  @Override
  protected Collection<String> getAPTOptions() {
    return Collections.singletonList("-Afluentq.packageSuffix=.query");
  }
}
