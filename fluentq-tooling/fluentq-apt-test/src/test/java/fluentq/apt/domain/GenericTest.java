...
import fluentq.apt.domain.rel.SimpleType;
import fluentq.apt.domain.rel.SimpleType2;
...
public class GenericTest extends AbstractTest {
  ...
  public static class GenericType2<T extends ItemType> {
    ...
    @QueryTransient GenericNumberType num1; // NOTE : doesn't work!
  ...
  public static class GenericNumberType<T> extends Number
      implements Comparable<GenericNumberType<T>> {
    @Override
