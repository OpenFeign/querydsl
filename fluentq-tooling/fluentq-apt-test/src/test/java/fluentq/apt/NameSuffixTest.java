...
public class NameSuffixTest extends AbstractProcessorTest {
  ...
  public void process_all() throws IOException {
    ...
    // default Processor
    process(FluentQAnnotationProcessor.class, classes, "suffix");

    assertThat(new File("target/suffix/fluentq/apt/domain/query2/QAnimalTest_AnimalType.java"))
        .exists();
  }

  @Override
  protected Collection<String> getAPTOptions() {
    return Arrays.asList("-Afluentq.packageSuffix=.query2", "-Afluentq.suffix=Type");
  }
}
