...
class EmbeddableSerializerTest {
    ...
    fun defaultGeneratedAnnotation() {
        ...
        assertThat(generatedSource).contains("@Generated(\"fluentq.kotlin.codegen.KotlinEmbeddableSerializer\")\npublic class")
    ...
    fun customGeneratedAnnotation() {
        ...
        assertThat(generatedSourceCode).contains("@Generated(\"fluentq.kotlin.codegen.KotlinEmbeddableSerializer\")\npublic class")
