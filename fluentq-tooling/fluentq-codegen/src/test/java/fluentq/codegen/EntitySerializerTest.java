...
public class EntitySerializerTest {
  ...
  public void javadocs_for_innerClass() throws IOException {
    var entityType = new EntityType(new ClassType(Entity.class));
    typeMappings.register(entityType, queryTypeFactory.create(entityType));

    serializer.serialize(entityType, SimpleSerializerConfig.DEFAULT, new JavaWriter(writer));
    assertThat(writer.toString())
        .contains("QEntitySerializerTest_Entity is a FluentQ query type for Entity");
  ...
  public void include() throws IOException {
    ...
    entityType.addProperty(
        new Property(entityType, "c", new ClassType(TypeCategory.COMPARABLE, String.class)));
    // entityType.addProperty(new Property(entityType, "cu", new ClassType(TypeCategory.CUSTOM,
    // PropertyType.class)));
    entityType.addProperty(
        new Property(entityType, "d", new ClassType(TypeCategory.DATE, Date.class)));
    entityType.addProperty(
        new Property(entityType, "e", new ClassType(TypeCategory.ENUM, PropertyType.class)));
    entityType.addProperty(
        new Property(entityType, "dt", new ClassType(TypeCategory.DATETIME, Date.class)));
    entityType.addProperty(
        new Property(entityType, "i", new ClassType(TypeCategory.NUMERIC, Integer.class)));
    entityType.addProperty(
  ...
  public void defaultGeneratedAnnotation() throws IOException {
    ...
    assertThat(generatedSourceCode)
        .containsIgnoringNewLines(
            "@Generated(\"fluentq.codegen.DefaultEntitySerializer\")\npublic class");
  ...
  public void customGeneratedAnnotation() throws IOException {
    ...
    new DefaultEntitySerializer(
            typeMappings, Collections.<String>emptySet(), fluentq.core.annotations.Generated.class)
        .serialize(entityType, SimpleSerializerConfig.DEFAULT, new JavaWriter(writer));
    var generatedSourceCode = writer.toString();
    assertThat(generatedSourceCode)
        .contains("import " + fluentq.core.annotations.Generated.class.getName() + ";");
    assertThat(generatedSourceCode)
        .containsIgnoringNewLines(
            "@"
                + fluentq.core.annotations.Generated.class.getSimpleName()
                + "(\"fluentq.codegen.DefaultEntitySerializer\")\npublic class");
    CompileUtils.assertCompiles("QEntitySerializerTest_Entity", generatedSourceCode);
  }
}
