...
import static fluentq.codegen.utils.StringUtils.capitalize;
import static fluentq.codegen.utils.Symbols.*;

import fluentq.codegen.utils.CodeWriter;
import fluentq.codegen.utils.model.*;
...
public class DefaultProjectionSerializer implements ProjectionSerializer {
  ...
  protected void intro(EntityType model, CodeWriter writer) throws IOException {
    ...
    // javadoc
    writer.javadoc(queryType + " is a FluentQ Projection type for " + simpleName);
