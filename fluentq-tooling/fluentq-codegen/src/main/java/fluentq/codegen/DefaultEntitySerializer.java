...
import static fluentq.codegen.utils.Symbols.ASSIGN;
import static fluentq.codegen.utils.Symbols.COMMA;
import static fluentq.codegen.utils.Symbols.DOT;
import static fluentq.codegen.utils.Symbols.EMPTY;
import static fluentq.codegen.utils.Symbols.NEW;
import static fluentq.codegen.utils.Symbols.QUOTE;
import static fluentq.codegen.utils.Symbols.RETURN;
import static fluentq.codegen.utils.Symbols.SEMICOLON;
import static fluentq.codegen.utils.Symbols.STAR;
import static fluentq.codegen.utils.Symbols.SUPER;
import static fluentq.codegen.utils.Symbols.THIS;
import static fluentq.codegen.utils.Symbols.THIS_ESCAPE;
import static fluentq.codegen.utils.Symbols.UNCHECKED;
...
import fluentq.codegen.utils.model.TypeExtends;
...
import fluentq.core.types.dsl.ArrayPath;
import fluentq.core.types.dsl.BooleanPath;
import fluentq.core.types.dsl.CollectionPath;
...
public class DefaultEntitySerializer implements EntitySerializer {
  ...
  protected void introImports(CodeWriter writer, SerializerConfig config, EntityType model)
    ...
    writer.importClasses("fluentq.core.types.dsl.StringTemplate");
  ...
  protected void introJavadoc(CodeWriter writer, EntityType model) throws IOException {
    var queryType = typeMappings.getPathType(model, model, true);
    writer.javadoc(
        queryType.getSimpleName() + " is a FluentQ query type for " + model.getSimpleName());
  }
