...
import static fluentq.codegen.BeanSerializer.DEFAULT_JAVADOC_SUFFIX;
...
public class CodegenModule extends AbstractModule {
   ...
   * element) to indicate that these have been generated. Defaults to java's {@code Generated}
   * annotation (depending on java version)
   */
