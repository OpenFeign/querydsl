...
public class AnnotationTest {
  ...
  public void ClassAnnotation() throws IOException {
    ...
    var option1 =
"""
@fluentq.codegen.utils.Annotation(clazz=fluentq.codegen.utils.AnnotationTest.class,\
 prop2=false)\
""";
    var option2 =
        """
        @fluentq.codegen.utils.Annotation(prop2=false,\
         clazz=fluentq.codegen.utils.AnnotationTest.class)\
        """;
  ...
  public void ClassAnnotation2() throws IOException {
    ...
    assertThat(w.toString().trim()).isEqualTo("@fluentq.codegen.utils.Annotation2(\"Hello\")");
  }
  ...
  public void ClassAnnotation3() throws IOException {
    ...
    assertThat(w.toString().trim())
        .isEqualTo(
            "@fluentq.codegen.utils.Annotation3(type=java.lang.annotation.ElementType.ANNOTATION_TYPE)");
  }
  ...
  public void Uri_Value() throws IOException {
    ...
    assertThat(w.toString().trim())
        .isEqualTo("@fluentq.codegen.utils.Annotation2(\"http://www.example.com#\")");
  }
}
