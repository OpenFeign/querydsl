...
import fluentq.codegen.utils.support.Cat;
...
public class ComplexEvaluationTest {
  ...
  public void ComplexClassLoading() {
    ...
    source.append(
        """
        for (fluentq.codegen.utils.support.Cat cat :\
         (java.util.List<fluentq.codegen.utils.support.Cat>)cat_){
        """);
    source.append(
        """
        for (fluentq.codegen.utils.support.Cat otherCat :\
         (java.util.List<fluentq.codegen.utils.support.Cat>)otherCat_){
        """);
  ...
  public void ComplexDifferentConstants() {
    ...
    var source =
        new StringBuilder()
            .append(
                """
                java.util.List<fluentq.codegen.utils.support.Cat> rv = new\
                 java.util.ArrayList<fluentq.codegen.utils.support.Cat>();
                """)
            .append(
                """
                for (fluentq.codegen.utils.support.Cat cat :\
