 ...
 */
package fluentq.codegen.utils.model;
...
public final class Types {
  ...
  public static final ClassType COLLECTION =
      new ClassType(TypeCategory.COLLECTION, Collection.class, OBJECT);
  ...
  public static final ClassType ITERABLE =
      new ClassType(TypeCategory.SIMPLE, Iterable.class, OBJECT);
