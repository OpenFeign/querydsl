...
class FluentQAnnotationProcessorCompileTest {
  ...
  void queryEntity_generatesQClass() {
    ...
    Compilation compilation =
        javac().withProcessors(new FluentQAnnotationProcessor()).compile(source);
  ...
  void circularQClassReference_producesWarning() {
    ...
    Compilation compilation =
        javac()
            .withProcessors(new FluentQAnnotationProcessor())
  ...
  void indirectCircularReference_producesWarning() {
    ...
    Compilation compilation =
        javac().withProcessors(new FluentQAnnotationProcessor()).compile(aSource, bSource, cSource);
  ...
  void entityWithInheritance_generatesQClasses() {
    ...
    Compilation compilation =
        javac().withProcessors(new FluentQAnnotationProcessor()).compile(superSource, subSource);
