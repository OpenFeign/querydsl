...
import fluentq.sql.codegen.MetaDataExporter;
import fluentq.sql.codegen.MetadataExporterConfig;
import fluentq.sql.codegen.NamingStrategy;
...
public abstract class AbstractMetaDataExportMojo extends AbstractMojo
  ...
  /** name prefix for fluentq-types (default: "Q") */
  @Parameter(defaultValue = "Q")
  private String namePrefix;

  /** name suffix for fluentq-types (default: "") */
  ...
  @Parameter(defaultValue = "false", property = "maven.fluentq.skip")
    ...
    try {
      ...
      if (createScalaSources) {
        if (serializerClass == null) {
          serializerClass = "fluentq.scala.sql.ScalaMetaDataSerializer";
        }
        if (exportBeans && beanSerializerClass == null) {
          beanSerializerClass = "fluentq.scala.ScalaBeanSerializer";
        }
      }
