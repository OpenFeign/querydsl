...
public class MongodbJoinTest {
  ...
  public void count() {
    assertEquals(
        1, where().join(user.friend(), friend).on(friend.firstName.eq("Max")).fetchCount());
    assertEquals(
        1,
  ...
  public void count_collection() {
    assertEquals(
        1, where().join(user.friends, friend).on(friend.firstName.eq("Mary")).fetchCount());
  ...
  public void list() {
    assertEquals(
        1, where().join(user.friend(), friend).on(friend.firstName.eq("Max")).fetch().size());
    assertEquals(
        1,
        where(user.firstName.eq("Jane"))
            .join(user.friend(), friend)
  ...
  public void list_collection() {
    assertEquals(
        1, where().join(user.friends, friend).on(friend.firstName.eq("Mary")).fetch().size());
  }
