...
import fluentq.core.domain.QAnimal;
...
/** QCat is a FluentQ query type for Cat */
public class QCatType extends EntityPathBase<Cat> {
  ...
  public final ListPath<Cat, QCatType> kittens =
      this.<Cat, QCatType>createList("kittens", Cat.class, QCatType.class, PathInits.DIRECT);

  public final SetPath<Cat, QCatType> kittensSet =
      this.<Cat, QCatType>createSet("kittensSet", Cat.class, QCatType.class, PathInits.DIRECT);
  ...
  public QCatType(Class<? extends Cat> type, PathMetadata metadata, PathInits inits) {
    ...
    this.mate =
        inits.isInitialized("mate") ? new QCatType(forProperty("mate"), inits.get("mate")) : null;
  }
