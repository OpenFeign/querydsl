...
import fluentq.core.support.DummyFetchableQuery;
...
public abstract class AbstractGroupByTest {
  ...
  protected static final DummyFetchableQuery<Tuple> BASIC_RESULTS =
      projectable(
  ...
  protected static final DummyFetchableQuery<Tuple> BASIC_RESULTS_UNORDERED =
      projectable(
          row(null, "null post", 8, "comment 8"),
          row(null, "null post", 7, "comment 7"),
          row(1, "post 1", 2, "comment 2"),
  ...
  protected static final DummyFetchableQuery<Tuple> MAP_RESULTS =
      projectable(
  ...
  protected static final DummyFetchableQuery<Tuple> MAP2_RESULTS =
      projectable(
  ...
  protected static final DummyFetchableQuery<Tuple> MAP3_RESULTS =
      projectable(
  ...
  protected static final DummyFetchableQuery<Tuple> MAP4_RESULTS =
      projectable(
  ...
  protected static final DummyFetchableQuery<Tuple> POST_W_COMMENTS =
      projectable(
  ...
  protected static final DummyFetchableQuery<Tuple> POST_W_COMMENTS2 =
      projectable(
  ...
  protected static final DummyFetchableQuery<Tuple> USERS_W_LATEST_POST_AND_COMMENTS =
      projectable(
  ...
  protected static final DummyFetchableQuery<Tuple> POSTS_W_COMMENTS_SCORE =
      projectable(row(null, 1.5), row(1, 1.5), row(1, 2.0), row(1, 0.5), row(2, 1.0), row(2, 2.0));
  ...
  protected static final NumberExpression<Integer> postId =
      Expressions.numberPath(Integer.class, post, "id");
  ...
  protected static final NumberPath<Integer> commentId =
      Expressions.numberPath(Integer.class, comment, "id");

  protected static final StringExpression commentText = Expressions.stringPath(comment, "text");

  protected static final NumberExpression<Double> score =
      Expressions.numberPath(Double.class, comment, "score");

  protected static final ConstructorExpression<Comment> qComment =
