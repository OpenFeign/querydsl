...
import fluentq.core.testutil.ThreadSafety;
...
class CycleClassInitDependencyTest {
  ...
  void test() {
    ...
    ThreadSafety.check(
        new LoadClassRunnable("fluentq.core.types.dsl.NumberExpression"),
        new LoadClassRunnable("fluentq.core.types.dsl.Expressions"));
  }
