...
import fluentq.core.types.SubQueryExpressionImpl;
import fluentq.core.types.Visitor;
import fluentq.core.types.dsl.BooleanExpression;
import fluentq.core.types.dsl.BooleanOperation;
import fluentq.core.types.dsl.Expressions;
import java.util.Arrays;
import java.util.Collection;

/**
 * {@code FetchableSubQueryBase} extends {@link FetchableQueryBase} to provide fluent Expression
 * creation functionality
 *
 * @param <T>
 * @param <Q>
 */
public abstract class ReactiveFetchableSubQueryBase<
        T, Q extends ReactiveFetchableSubQueryBase<T, Q>>
    extends ReactiveFetchableQueryBase<T, Q> implements ExtendedSubQuery<T> {

  private final SubQueryExpression<T> mixin;

  @SuppressWarnings("unchecked")
  public ReactiveFetchableSubQueryBase(QueryMixin<Q> queryMixin) {
    super(queryMixin);
