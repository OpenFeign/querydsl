...
public abstract class StringExpression extends LiteralExpression<String> {
  ...
  @Nullable private transient volatile StringExpression min, max;

  @Nullable private transient volatile BooleanExpression isempty;
   ...
   *
   * <p>Get the concatenation of this and str
   *
   ...
   *
   * <p>Get the character at the given index
   *
   ...
   *
   * <p>Returns true if the given String is contained, compare case insensitively
   *
   * @param str string
   ...
   *
   * <p>Returns true if this ends with str
   *
   * @param str string
   ...
   *
   * <p>Returns true if this ends with str, compares case insensitively
   *
   * @param str string
   ...
   *
   * <p>Get the index of the given substring in this String
   *
   * @param str string
   ...
   *
   * <p>Get the index of the given substring in this String, starting from the given index
   *
   * @param str string
   * @param i zero based index
  ...
  public NumberExpression<Integer> indexOf(Expression<String> str, int i) {
    return Expressions.numberOperation(
        Integer.class, Ops.INDEX_OF_2ARGS, mixin, str, ConstantImpl.create(i));
  }

  /**
   * Create a {@code this.isEmpty()} expression
   *
   * <p>Return true if this String is empty
   *
   * @return this.isEmpty()
   ...
   * Create a {@code !this.isEmpty()} expression
   *
   * <p>Return true if this String is not empty
   *
   * @return !this.isEmpty()
   * @see java.lang.String#isEmpty()
   */
   ...
   *
   * <p>Return the length of this String
   *
   * @return this.length()
  ...
  public BooleanExpression like(String str, char escape) {
    return Expressions.booleanOperation(
        Ops.LIKE_ESCAPE, mixin, ConstantImpl.create(str), ConstantImpl.create(escape));
  }
  ...
  public BooleanExpression likeIgnoreCase(String str, char escape) {
    return Expressions.booleanOperation(
        Ops.LIKE_ESCAPE_IC, mixin, ConstantImpl.create(str), ConstantImpl.create(escape));
  }
  ...
  public BooleanExpression likeIgnoreCase(Expression<String> str, char escape) {
    return Expressions.booleanOperation(
        Ops.LIKE_ESCAPE_IC, mixin, str, ConstantImpl.create(escape));
  }

  /**
   * Create a {@code locate(str, this)} expression
   *
   * <p>Get the position of the given String in this String, the first position is 1
   *
   * @param str string
  ...
  public NumberExpression<Integer> locate(String str) {
    return Expressions.numberOperation(
        Integer.class, Ops.StringOps.LOCATE, ConstantImpl.create(str), mixin);
  }
  ...
  public NumberExpression<Integer> locate(String str, int start) {
    return Expressions.numberOperation(
        Integer.class,
        Ops.StringOps.LOCATE2,
        ConstantImpl.create(str),
        mixin,
        ConstantImpl.create(start));
  }
  ...
  public NumberExpression<Integer> locate(String str, Expression<Integer> start) {
    return Expressions.numberOperation(
        Integer.class, Ops.StringOps.LOCATE2, ConstantImpl.create(str), mixin, start);
  }

  /**
   * Create a {@code this.toLowerCase()} expression
   *
   * <p>Get the lower case form
   *
   ...
   *
   * <p>Return true if this String matches the given regular expression
   *
   * <p>Some implementations such as FluentQ JPA will try to convert a regex expression into like
   * form and will throw an Exception when this fails
   *
   ...
   *
   * <p>Prepend the given String and return the result
   *
   * @param str string
   * @return str + this
   */
   ...
   *
   * <p>Return true if this starts with str
   *
   * @param str string
  ...
  public StringExpression substring(int beginIndex, int endIndex) {
    return Expressions.stringOperation(
        Ops.SUBSTR_2ARGS, mixin, ConstantImpl.create(beginIndex), ConstantImpl.create(endIndex));
  }
  ...
  public StringExpression substring(Expression<Integer> beginIndex, int endIndex) {
    return Expressions.stringOperation(
        Ops.SUBSTR_2ARGS, mixin, beginIndex, ConstantImpl.create(endIndex));
  }
  ...
  public StringExpression substring(int beginIndex, Expression<Integer> endIndex) {
    return Expressions.stringOperation(
        Ops.SUBSTR_2ARGS, mixin, ConstantImpl.create(beginIndex), endIndex);
  }
   ...
   *
   * <p>Create a copy of the string, with leading and trailing whitespace omitted.
   *
   * @return this.trim()
