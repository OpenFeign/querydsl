...
public class NameBasedProjection<T> extends FactoryExpressionBase<T> {
   ...
   * <h3>Purpose</h3>
   *
   * Simplifies FluentQ projection by automatically binding entity fields to DTO constructor or
   ...
   *   <li><b>entity</b> — The FluentQ {@link EntityPathBase} whose fields will be automatically
   *       mapped.
   * </ul>
   *
   * <h3>Return</h3>
   ...
   * @param entity the FluentQ entity path whose field expressions are used
