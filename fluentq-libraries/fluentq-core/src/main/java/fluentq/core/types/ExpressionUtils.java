...
import fluentq.core.BooleanBuilder;
 ...
 * class is used internally in FluentQ and is not suitable to be used in cases where DSL methods are
 * needed, since the Expression implementations used in this class are minimal internal
 * implementations.
 *
 * @author tiwe
 */
