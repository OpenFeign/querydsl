...
import fluentq.core.types.ParameterizedPathImpl;
...
public class MapPath<K, V, E extends SimpleExpression<? super V>> extends MapExpressionBase<K, V, E>
  ...
  @Nullable private transient Constructor<E> constructor;

  private final Class<V> valueType;

  protected MapPath(
      Class<? super K> keyType, Class<? super V> valueType, Class<E> queryType, String variable) {
  ...
  private E newInstance(PathMetadata pm)
