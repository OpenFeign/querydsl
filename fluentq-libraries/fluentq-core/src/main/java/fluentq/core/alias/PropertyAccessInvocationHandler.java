...
import fluentq.core.types.ParameterizedExpression;
...
public class PropertyAccessInvocationHandler {
  ...
  protected PropertyAccessInvocationHandler(
      Expression<?> host,
  ...
  protected <T> T newInstance(
      Class<T> type, Type genericType, Object parent, Object propKey, PathMetadata metadata) {
    Expression<?> path;
    Object rv;
