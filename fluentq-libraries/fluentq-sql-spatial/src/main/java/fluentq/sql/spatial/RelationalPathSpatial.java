...
import fluentq.spatial.GeometryCollectionPath;
import fluentq.spatial.GeometryPath;
import fluentq.spatial.GeometryPaths;
import fluentq.spatial.LineStringPath;
import fluentq.spatial.LinearRingPath;
import fluentq.spatial.MultiLineStringPath;
import fluentq.spatial.MultiPointPath;
import fluentq.spatial.MultiPolygonPath;
import fluentq.spatial.PointPath;
import fluentq.spatial.PolygonPath;
...
public class RelationalPathSpatial<T> extends RelationalPathBase<T> implements GeometryPaths {
  ...
  @Override
  public <A extends Geometry> GeometryPath<A> createGeometry(
      String property, Class<? extends A> type) {
    return add(new GeometryPath<A>(type, forProperty(property)));
  }

  @Override
  public <A extends LinearRing> LinearRingPath<A> createLinearRing(
      String property, Class<? extends A> type) {
    return add(new LinearRingPath<A>(type, forProperty(property)));
  }

  @Override
  public <A extends LineString> LineStringPath<A> createLineString(
      String property, Class<? extends A> type) {
  ...
  @Override
  public <A extends MultiPoint> MultiPointPath<A> createMultiPoint(
      String property, Class<? extends A> type) {
    return add(new MultiPointPath<A>(type, forProperty(property)));
  }

  @Override
  public <A extends MultiPolygon> MultiPolygonPath<A> createMultiPolygon(
      String property, Class<? extends A> type) {
  ...
  @Override
  public <A extends Polygon> PolygonPath<A> createPolygon(
      String property, Class<? extends A> type) {
