 ...
 */
package fluentq.jpa.hibernate.sql;
...
import fluentq.jpa.hibernate.SessionHolder;
import fluentq.jpa.hibernate.StatelessSessionHolder;
...
public abstract class AbstractHibernateSQLQuery<T, Q extends AbstractHibernateSQLQuery<T, Q>>
  ...
  public AbstractHibernateSQLQuery(
      SessionHolder session, Configuration conf, QueryMetadata metadata) {
    super(metadata, conf);
