...
/**
 * {@code JPQLSerializer} serializes FluentQ expressions into JPQL syntax.
 *
 * @author tiwe
 */
public class JPQLSerializer extends SerializerBase<JPQLSerializer> {
          ...
          throw new IllegalArgumentException(
              String.format(
                  ...
                  SQL Expressions like %s are not supported in JPQL - the query language for JPA.\
                   ...
                   Consider using the Blaze-Persistence FluentQ integration.\
  ...
  private boolean isCollectionPathWithConverterToBasicType(Path<?> path, Metamodel metamodel) {
    ...
    try {
      ...
      System.err.println(
          "FluentQ-JPA (DEBUG): Metamodel lookup failed for " + path + ": " + e.getMessage());
      return false;
    }
  }
