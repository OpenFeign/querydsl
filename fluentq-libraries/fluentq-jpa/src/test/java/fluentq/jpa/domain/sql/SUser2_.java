...
/** SUser2_ is a FluentQ query type for SUser2_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SUser2_ extends fluentq.sql.RelationalPathBase<SUser2_> {
  ...
  public final fluentq.sql.PrimaryKey<SUser2_> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SUser2_userprop_> _user2_userprop_User2IDFK =
