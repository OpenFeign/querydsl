...
/** SUser_ is a FluentQ query type for SUser_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SUser_ extends fluentq.sql.RelationalPathBase<SUser_> {
  ...
  public final fluentq.sql.PrimaryKey<SUser_> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SCompany_> user_COMPANYIDFK =
      createForeignKey(companyId, "ID");

  public final fluentq.sql.ForeignKey<SEmployee_> _employee_USERIDFK =
