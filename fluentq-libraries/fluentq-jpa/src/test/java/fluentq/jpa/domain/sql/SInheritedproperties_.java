...
/** SInheritedproperties_ is a FluentQ query type for SInheritedproperties_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SInheritedproperties_ extends fluentq.sql.RelationalPathBase<SInheritedproperties_> {
  ...
  public final fluentq.sql.PrimaryKey<SInheritedproperties_> primary = createPrimaryKey(id);
