...
/** SEviltype_ is a FluentQ query type for SEviltype_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SEviltype_ extends fluentq.sql.RelationalPathBase<SEviltype_> {
  ...
  public final fluentq.sql.PrimaryKey<SEviltype_> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_GETCLASSIDFK =
      createForeignKey(getclassId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_GETMETADATAIDFK =
      createForeignKey(getmetadataId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_GETTYPEIDFK =
      createForeignKey(gettypeId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_GETIDFK = createForeignKey(getId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_HASHCODEIDFK =
      createForeignKey(hashcodeId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_ISNOTNULLIDFK =
      createForeignKey(isnotnullId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_ISNULLIDFK =
      createForeignKey(isnullId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_NOTIFYALLIDFK =
      createForeignKey(notifyallId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_NOTIFYIDFK =
      createForeignKey(notifyId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_TOSTRINGIDFK =
      createForeignKey(tostringId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_WAITIDFK =
      createForeignKey(waitId, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_AscFK = createForeignKey(_asc, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> eviltype_DescFK = createForeignKey(_desc, "ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_GETCLASSIDFK =
      createInvForeignKey(id, "GETCLASS_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_GETMETADATAIDFK =
      createInvForeignKey(id, "GETMETADATA_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_GETTYPEIDFK =
      createInvForeignKey(id, "GETTYPE_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_GETIDFK =
      createInvForeignKey(id, "GET_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_HASHCODEIDFK =
      createInvForeignKey(id, "HASHCODE_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_ISNOTNULLIDFK =
      createInvForeignKey(id, "ISNOTNULL_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_ISNULLIDFK =
      createInvForeignKey(id, "ISNULL_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_NOTIFYALLIDFK =
      createInvForeignKey(id, "NOTIFYALL_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_NOTIFYIDFK =
      createInvForeignKey(id, "NOTIFY_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_TOSTRINGIDFK =
      createInvForeignKey(id, "TOSTRING_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_WAITIDFK =
      createInvForeignKey(id, "WAIT_ID");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_AscFK = createInvForeignKey(id, "_asc");

  public final fluentq.sql.ForeignKey<SEviltype_> _eviltype_DescFK =
