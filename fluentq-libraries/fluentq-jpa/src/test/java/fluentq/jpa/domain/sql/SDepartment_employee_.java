...
/** SDepartment_employee_ is a FluentQ query type for SDepartment_employee_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SDepartment_employee_ extends fluentq.sql.RelationalPathBase<SDepartment_employee_> {
  ...
  public final fluentq.sql.PrimaryKey<SDepartment_employee_> primary =
      createPrimaryKey(departmentID, employeesID);

  public final fluentq.sql.ForeignKey<SDepartment_> department_employee_DepartmentIDFK =
      createForeignKey(departmentID, "ID");

  public final fluentq.sql.ForeignKey<SEmployee_> department_employee_employeesIDFK =
