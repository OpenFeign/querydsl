...
/** SItem_ is a FluentQ query type for SItem_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SItem_ extends fluentq.sql.RelationalPathBase<SItem_> {
  ...
  public final fluentq.sql.PrimaryKey<SItem_> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SStatus_> item_CURRENTSTATUSIDFK =
      createForeignKey(currentstatusId, "ID");

  public final fluentq.sql.ForeignKey<SItem_> item_PRODUCTIDFK = createForeignKey(productId, "ID");

  public final fluentq.sql.ForeignKey<SStatus_> item_STATUSIDFK = createForeignKey(statusId, "ID");

  public final fluentq.sql.ForeignKey<SLineItems2> _lineItems2LineItemsMapIDFK =
      createInvForeignKey(id, "lineItemsMap_ID");

  public final fluentq.sql.ForeignKey<SLineItems> _lineItemsLineItemsIDFK =
      createInvForeignKey(id, "lineItems_ID");

  public final fluentq.sql.ForeignKey<SAuditlog_> _auditlog_ITEMIDFK =
      createInvForeignKey(id, "ITEM_ID");

  public final fluentq.sql.ForeignKey<SItem_> _item_PRODUCTIDFK =
      createInvForeignKey(id, "PRODUCT_ID");

  public final fluentq.sql.ForeignKey<SItem_statuschange_> _item_statuschange_PaymentIDFK =
      createInvForeignKey(id, "Payment_ID");

  public final fluentq.sql.ForeignKey<SOrder_item_> _order_item_itemsIDFK =
      createInvForeignKey(id, "items_ID");

  public final fluentq.sql.ForeignKey<SPrice_> _price_PRODUCTIDFK =
      createInvForeignKey(id, "PRODUCT_ID");
