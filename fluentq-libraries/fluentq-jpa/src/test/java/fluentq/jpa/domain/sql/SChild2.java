...
/** SChild2 is a FluentQ query type for SChild2 */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SChild2 extends fluentq.sql.RelationalPathBase<SChild2> {
  ...
  public final fluentq.sql.PrimaryKey<SChild2> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SParent2> child2ParentIdFk = createForeignKey(parentId, "ID");
