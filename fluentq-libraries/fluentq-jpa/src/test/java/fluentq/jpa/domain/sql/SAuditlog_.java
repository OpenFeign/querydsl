...
/** SAuditlog_ is a FluentQ query type for SAuditlog_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SAuditlog_ extends fluentq.sql.RelationalPathBase<SAuditlog_> {
  ...
  public final fluentq.sql.PrimaryKey<SAuditlog_> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SItem_> auditlog_ITEMIDFK = createForeignKey(itemId, "ID");
