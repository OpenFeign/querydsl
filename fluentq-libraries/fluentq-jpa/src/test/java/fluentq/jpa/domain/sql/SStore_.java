...
/** SStore_ is a FluentQ query type for SStore_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SStore_ extends fluentq.sql.RelationalPathBase<SStore_> {
  ...
  public final fluentq.sql.PrimaryKey<SStore_> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SLocation_> store_LOCATIONIDFK =
      createForeignKey(locationId, "ID");

  public final fluentq.sql.ForeignKey<SStore_customer_> _store_customer_StoreIDFK =
