...
/** SMyotherentity is a FluentQ query type for SMyotherentity */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SMyotherentity extends fluentq.sql.RelationalPathBase<SMyotherentity> {
  ...
  public final fluentq.sql.PrimaryKey<SMyotherentity> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SMyentity> _myentityAttributewithinitproblemIdFk =
