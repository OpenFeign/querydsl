...
/** SGroup_ is a FluentQ query type for SGroup_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SGroup_ extends fluentq.sql.RelationalPathBase<SGroup_> {
  ...
  public final fluentq.sql.PrimaryKey<SGroup_> primary = createPrimaryKey(id);
