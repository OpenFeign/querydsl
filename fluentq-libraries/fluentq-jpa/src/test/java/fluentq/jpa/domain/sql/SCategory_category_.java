...
/** SCategory_category_ is a FluentQ query type for SCategory_category_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SCategory_category_ extends fluentq.sql.RelationalPathBase<SCategory_category_> {
  ...
  public final fluentq.sql.PrimaryKey<SCategory_category_> primary =
      createPrimaryKey(childId, parentId);

  public final fluentq.sql.ForeignKey<SCategory_> category_category_childIdFK =
      createForeignKey(childId, "ID");

  public final fluentq.sql.ForeignKey<SCategory_> category_category_parentIdFK =
