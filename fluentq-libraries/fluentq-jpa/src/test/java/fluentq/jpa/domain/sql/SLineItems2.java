...
/** SLineItems2 is a FluentQ query type for SLineItems2 */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SLineItems2 extends fluentq.sql.RelationalPathBase<SLineItems2> {
  ...
  public final fluentq.sql.PrimaryKey<SLineItems2> primary =
      createPrimaryKey(orderID, lineItemsMapID);

  public final fluentq.sql.ForeignKey<SOrder_> lineItems2OrderIDFK =
      createForeignKey(orderID, "ID");

  public final fluentq.sql.ForeignKey<SItem_> lineItems2LineItemsMapIDFK =
