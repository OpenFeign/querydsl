...
/** SPerson_ is a FluentQ query type for SPerson_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SPerson_ extends fluentq.sql.RelationalPathBase<SPerson_> {
  ...
  public final fluentq.sql.PrimaryKey<SPerson_> primary = createPrimaryKey(i);

  public final fluentq.sql.ForeignKey<SNationality_> person_NATIONALITYIDFK =
      createForeignKey(nationalityId, "ID");

  public final fluentq.sql.ForeignKey<SPersonid_> person_PIDIDFK = createForeignKey(pidId, "ID");

  public final fluentq.sql.ForeignKey<SAccount_> _account_OWNERIFK =
