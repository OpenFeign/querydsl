...
/** SNumeric_ is a FluentQ query type for SNumeric_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SNumeric_ extends fluentq.sql.RelationalPathBase<SNumeric_> {
  ...
  public final fluentq.sql.PrimaryKey<SNumeric_> primary = createPrimaryKey(id);
