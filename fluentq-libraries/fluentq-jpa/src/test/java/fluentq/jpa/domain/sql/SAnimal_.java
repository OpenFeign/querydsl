...
/** SAnimal_ is a FluentQ query type for SAnimal_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SAnimal_ extends fluentq.sql.RelationalPathBase<SAnimal_> {
  ...
  public final fluentq.sql.PrimaryKey<SAnimal_> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SAnimal_> animal_MATEIDFK = createForeignKey(mateId, "ID");

  public final fluentq.sql.ForeignKey<SAnimal_> _animal_MATEIDFK =
      createInvForeignKey(id, "MATE_ID");

  public final fluentq.sql.ForeignKey<SKittens> _kittensCatIdFK = createInvForeignKey(id, "cat_id");

  public final fluentq.sql.ForeignKey<SKittens> _kittensKittenIdFK =
      createInvForeignKey(id, "kitten_id");

  public final fluentq.sql.ForeignKey<SKittensSet> _kittensSetCatIdFK =
      createInvForeignKey(id, "cat_id");

  public final fluentq.sql.ForeignKey<SKittensSet> _kittensSetKittenIdFK =
      createInvForeignKey(id, "kitten_id");
