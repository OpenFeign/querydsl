...
/** SUser2_userprop_ is a FluentQ query type for SUser2_userprop_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SUser2_userprop_ extends fluentq.sql.RelationalPathBase<SUser2_userprop_> {
  ...
  public final fluentq.sql.PrimaryKey<SUser2_userprop_> primary =
      createPrimaryKey(user2ID, propertiesID);

  public final fluentq.sql.ForeignKey<SUser2_> user2_userprop_User2IDFK =
      createForeignKey(user2ID, "ID");

  public final fluentq.sql.ForeignKey<SUserprop_> user2_userprop_propertiesIDFK =
