...
/** SUserprop_ is a FluentQ query type for SUserprop_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SUserprop_ extends fluentq.sql.RelationalPathBase<SUserprop_> {
  ...
  public final fluentq.sql.PrimaryKey<SUserprop_> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SUser2_userprop_> _user2_userprop_propertiesIDFK =
      createInvForeignKey(id, "properties_ID");

  public final fluentq.sql.ForeignKey<SUserprop_category_> _userprop_category_UserPropIDFK =
      createInvForeignKey(id, "UserProp_ID");

  public final fluentq.sql.ForeignKey<SUserprop_categoryprop_> _userprop_categoryprop_UserPropIDFK =
      createInvForeignKey(id, "UserProp_ID");
