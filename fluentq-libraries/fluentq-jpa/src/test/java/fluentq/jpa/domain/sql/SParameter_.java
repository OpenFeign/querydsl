...
/** SParameter_ is a FluentQ query type for SParameter_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SParameter_ extends fluentq.sql.RelationalPathBase<SParameter_> {
  ...
  public final fluentq.sql.PrimaryKey<SParameter_> primary = createPrimaryKey(id);

  public final fluentq.sql.ForeignKey<SFormula_> _formula_PARAMETERIDFK =
