...
/** SDocument2_ is a FluentQ query type for SDocument2_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SDocument2_ extends fluentq.sql.RelationalPathBase<SDocument2_> {
  ...
  public final fluentq.sql.PrimaryKey<SDocument2_> primary = createPrimaryKey(id);
