...
/** SSimpletypes_ is a FluentQ query type for SSimpletypes_ */
@Generated("fluentq.sql.codegen.MetaDataSerializer")
public class SSimpletypes_ extends fluentq.sql.RelationalPathBase<SSimpletypes_> {
  ...
  public final fluentq.sql.PrimaryKey<SSimpletypes_> primary = createPrimaryKey(id);
