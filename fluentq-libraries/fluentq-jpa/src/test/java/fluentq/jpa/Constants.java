...
import fluentq.jpa.domain.QAuditLog;
import fluentq.jpa.domain.QBar;
import fluentq.jpa.domain.QCalendar;
import fluentq.jpa.domain.QCat;
import fluentq.jpa.domain.QCatalog;
import fluentq.jpa.domain.QCompany;
import fluentq.jpa.domain.QCustomer;
import fluentq.jpa.domain.QDocument;
import fluentq.jpa.domain.QDomesticCat;
import fluentq.jpa.domain.QFoo;
import fluentq.jpa.domain.QFormula;
import fluentq.jpa.domain.QItem;
import fluentq.jpa.domain.QName;
import fluentq.jpa.domain.QNameList;
import fluentq.jpa.domain.QNamed;
import fluentq.jpa.domain.QOrder;
import fluentq.jpa.domain.QParameter;
import fluentq.jpa.domain.QPayment;
import fluentq.jpa.domain.QPerson;
import fluentq.jpa.domain.QPlayer;
import fluentq.jpa.domain.QPrice;
import fluentq.jpa.domain.QProduct;
import fluentq.jpa.domain.QShow;
import fluentq.jpa.domain.QStatus;
import fluentq.jpa.domain.QStatusChange;
import fluentq.jpa.domain.QStore;
