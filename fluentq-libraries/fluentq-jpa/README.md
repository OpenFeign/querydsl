        ...
        <executions>
          <execution>
            ...
            <configuration>
              ...
              <processor>fluentq.apt.jpa.JPAAnnotationProcessor</processor>
            </configuration>
          </execution>
        </executions>
        <dependencies>
...
If you use Hibernate annotations in your domain types you should use the APT processor fluentq.apt.hibernate.HibernateAnnotationProcessor instead.
...
Querying with FluentQ JPA is as simple as this :
...
For more information on the FluentQ JPA module visit the reference documentation http://www.fluentq.com/static/fluentq/latest/reference/html/ch02.html#jpa_integration
