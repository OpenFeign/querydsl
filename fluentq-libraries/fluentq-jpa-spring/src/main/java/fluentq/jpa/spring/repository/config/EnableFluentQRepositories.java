 ...
 */
package fluentq.jpa.spring.repository.config;

import fluentq.jpa.spring.repository.support.FluentQJpaRepositoryFactoryBean;
...
/**
 * Annotation to enable FluentQ repositories. Will scan the package of the annotated configuration
 * class for Spring Data repositories by default.
 *
 * <p>This annotation is a meta-annotation for {@link EnableJpaRepositories @EnableJpaRepositories}
 * overriding the default {@link #repositoryFactoryBeanClass} to {@link
 * FluentQJpaRepositoryFactoryBean}.
 *
...
public @interface EnableFluentQRepositories {

  /**
   * Alias for the {@link #basePackages()} attribute. Allows for more concise annotation
   * declarations e.g.: {@code @EnableJpaRepositories("org.my.pkg")} instead of
   * {@code @EnableFluentQRepositories(basePackages="org.my.pkg")}.
   */
   ...
   * {@link FluentQJpaRepositoryFactoryBean}.
   *
   * @return
   */
  @AliasFor(annotation = EnableJpaRepositories.class)
  Class<?> repositoryFactoryBeanClass() default FluentQJpaRepositoryFactoryBean.class;
   ...
   * create repositories discovered through this annotation. Defaults to {@code transactionManager}.
   *
   * @return
   */
  @AliasFor(annotation = EnableJpaRepositories.class)
  ...
  /**
   * Configures what character is used to escape the wildcards {@literal _} and {@literal %} in
   * derived queries with {@literal contains}, {@literal startsWith} or {@literal endsWith} clauses.
   *
