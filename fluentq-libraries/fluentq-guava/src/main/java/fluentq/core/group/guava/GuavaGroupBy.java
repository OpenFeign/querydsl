...
import fluentq.core.ResultTransformer;
import fluentq.core.group.AbstractGroupExpression;
...
/**
 * {@code GuavaGroupBy} extends {@code GroupBy} with factory methods for creating {@link
 * ResultTransformer} and {@link GroupExpression} instances for Guava Collection types.
 *
...
public final class GuavaGroupBy extends GroupBy {
   ...
   */
  public static <K, V> AbstractGroupExpression<Pair<K, V>, Multimap<K, V>> multimap(
  ...
  public static <K extends Comparable<? super K>, V extends Comparable<? super V>>
      AbstractGroupExpression<Pair<K, V>, SortedSetMultimap<K, V>> sortedSetMultimap(
          Expression<K> key, Expression<V> value) {
   ...
   * @return wrapper expression
   */
  public static <R, C, V> AbstractGroupExpression<Pair<Pair<R, C>, V>, Table<R, C, V>> table(
   ...
   */
  public static <R, C, V>
      AbstractGroupExpression<Pair<Pair<R, C>, V>, TreeBasedTable<R, C, V>> sortedTable(
          Expression<R> row,
          Expression<C> column,
          Expression<V> value,
          Comparator<? super R> rowComparator,
          Comparator<? super C> columnComparator) {
    return GTable.createSorted(
        QPair.create(QPair.create(row, column), value), rowComparator, columnComparator);
  }
   ...
   * @return wrapper expression
   */
  public static <R, C, V, W>
      AbstractGroupExpression<Pair<Pair<R, C>, V>, TreeBasedTable<W, C, V>> sortedTable(
          GroupExpression<R, W> row,
          Expression<C> column,
          Expression<V> value,
   ...
   * @return wrapper expression
   */
  public static <R, C, V, W, X>
      AbstractGroupExpression<Pair<Pair<R, C>, V>, TreeBasedTable<W, X, V>> sortedTable(
          GroupExpression<R, W> row,
   ...
   */
  public static <R, C, V, W>
      AbstractGroupExpression<Pair<Pair<R, C>, V>, TreeBasedTable<R, W, V>> sortedTable(
          Expression<R> row,
   ...
   */
  public static <R, C, V, W, X>
      AbstractGroupExpression<Pair<Pair<R, C>, V>, TreeBasedTable<R, X, W>> sortedTable(
          Expression<R> row,
          GroupExpression<C, X> column,
   ...
   */
  public static <R, C, V, W, X>
      AbstractGroupExpression<Pair<Pair<R, C>, V>, TreeBasedTable<X, C, W>> sortedTable(
          GroupExpression<R, X> row,
          Expression<C> column,
          GroupExpression<V, W> value,
   ...
   */
  public static <R, C, V, W>
      AbstractGroupExpression<Pair<Pair<R, C>, V>, TreeBasedTable<R, C, W>> sortedTable(
          Expression<R> row,
          Expression<C> column,
          GroupExpression<V, W> value,
          Comparator<? super R> rowComparator,
   ...
   */
  public static <R, C, V, T, U, W>
      AbstractGroupExpression<Pair<Pair<R, C>, V>, TreeBasedTable<T, U, W>> sortedTable(
          GroupExpression<R, T> row,
