...
public class GroupBy2Test {
  ...
  @Test
  public void test() {
    var user = QGroupBy2Test_User.user;
    var role = QGroupBy2Test_Role.role;
    var group = QGroupBy2Test_SecurityGroup.securityGroup;
