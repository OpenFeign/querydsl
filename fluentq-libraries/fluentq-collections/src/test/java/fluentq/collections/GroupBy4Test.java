...
import static fluentq.core.group.GroupBy.list;
import static fluentq.core.group.GroupBy.map;
import static fluentq.core.group.guava.GuavaGroupBy.groupBy;
...
import fluentq.core.group.guava.GuavaGroupBy;
...
public class GroupBy4Test {
  ...
  public void test() {
    ...
    var table = QGroupBy4Test_Table.table;
  ...
  public void test7() {
    ...
    var expected =
        ImmutableMap
            .<String, com.google.common.collect.Table<String, String, Map<String, List<String>>>>
                builder()
            .put(
                "1",
  ...
  public void test8() {
    ...
    com.google.common.collect.Table<String, Map<String, String>, List<String>> transform =
        CollQueryFactory.from(table, data)
            .transform(
                groupBy(table.col1).asTable(map(table.col1, table.col2), GroupBy.list(table.col3)));
