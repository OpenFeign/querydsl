...
import fluentq.core.EmptyMetadata;
...
/**
 * {@code GuavaHelpers} provides functionality to wrap FluentQ {@link Predicate} instances to Guava
 * predicates and FluentQ {@link Expression} instances to Guava functions
 *
 * @author tiwe
 */
public final class FunctionalHelpers {
  ...
  /**
   * Wrap a FluentQ predicate into a Guava predicate
   *
  ...
  /**
   * Wrap a FluentQ expression into a Guava function
   *
