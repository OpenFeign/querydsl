...
import fluentq.core.dml.DMLClause;
...
import fluentq.sql.mysql.MySQLReplaceClause;
import fluentq.sql.teradata.TeradataQuery;
import fluentq.sql.types.XMLAsStringType;
