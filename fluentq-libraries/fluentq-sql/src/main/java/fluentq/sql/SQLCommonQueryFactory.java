...
import fluentq.core.QueryFactory;
...
import fluentq.sql.dml.SQLMergeClause;
import fluentq.sql.dml.SQLUpdateClause;

/**
 * Factory interface for query and clause creation.
 *
 * <p>The default implementation is {@link SQLQueryFactory} and should be used for general query
...
public interface SQLCommonQueryFactory<
        Q extends SQLCommonQuery<?>, // extends AbstractSQLQuery<?>
  ...
  /* (non-Javadoc)
   * @see fluentq.core.QueryFactory#query()
   */
  @Override
  Q query();
}
