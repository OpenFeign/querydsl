...
import fluentq.scala.ManifestUtils._
...
object Paths {
  ...
  def array[T <: Array[_]](t: Class[T], md: Metadata) = new ArrayPath[T](t, md)

  def dsl[T](t: Class[_ <: T], md: Metadata) = new DslPath[T](t, md)

  def simple[T](t: Class[_ <: T], md: Metadata) = new SimplePath[T](t, md)

  def entity[T](t: Class[_ <: T], md: Metadata) = new EntityPathImpl[T](t, md)

  def collection[T, Q <: Ex[_ >: T]](t: Class[T], q: Class[Q], md: Metadata) = {
    new CollectionPath[T,Q](t, q, md)
  }

  def set[T, Q <: Ex[_ >: T]](t: Class[T], q: Class[Q], md: Metadata) = new SetPath[T,Q](t, q, md)

  def list[T, Q <: Ex[_ >: T]](t: Class[T], q: Class[Q], md: Metadata) = new ListPath[T,Q](t, q, md)

  def map[K, V, Q <: Ex[_ >: V]](k: Class[K], v: Class[V], q: Class[Q], md: Metadata) = {
    new MapPath[K, V, Q](k, v, q, md)
  }

  def comparable[T <: Comparable[_]](t: Class[_ <: T], md: Metadata) = new ComparablePath[T](t, md)

  def date[T <: Comparable[_]](t: Class[_ <: T], md: Metadata) = new DatePath[T](t, md)

  def dateTime[T <: Comparable[_]](t: Class[_ <: T], md: Metadata) = new DateTimePath[T](t, md)

  def time[T <: Comparable[_]](t: Class[_ <: T], md: Metadata) = new TimePath[T](t, md)

  def number[T : Numeric](t: Class[T], md: Metadata) = new NumberPath[T](t, md)

  def boolean(md: Metadata) = new BooleanPath(md)
  ...
  def create[T, Q <: Ex[_ >: T]](t :Class[T], q: Class[Q], md: Metadata): Q = q match {
    case _ if q == classOf[StringPath] | q == classOf[BooleanPath] => {
      q.getConstructor(classOf[PathMetadata]).newInstance(md)
    }
    case _ => q.getConstructor(classOf[Class[_]], classOf[PathMetadata]).newInstance(t, md)
  }

}

class DslPath[T](t: Class[_ <: T], md: PathMetadata)
...
class SimplePath[T](t: Class[_ <: T], md: PathMetadata)
...
class ArrayPath[T <: Array[_]](t: Class[T], md: PathMetadata)
...
class BeanPath[T](t: Class[_ <: T], md: PathMetadata)
  extends PathImpl[T](t, md) with SimpleExpression[T] {
...
class EntityPathImpl[T](t: Class[_ <: T], md: PathMetadata)
...
class CollectionPath[T, Q <: Ex[_ >: T]](t: Class[T], q: Class[Q], md: PathMetadata)
  extends PathImpl[java.util.Collection[T]](classOf[java.util.Collection[T]], md) with fluentq.scala.CollectionExpression[T,Q] {
...
class SetPath[T, Q <: Ex[_ >: T]](t: Class[T],  q: Class[Q], md: PathMetadata)
...
class ListPath[T, Q <: Ex[_ >: T]](t: Class[T],  q: Class[Q], md: PathMetadata)
...
class MapPath[K, V, Q <: Ex[_ >: V]](k: Class[K], v: Class[V], q: Class[Q], md: PathMetadata)
  extends PathImpl[java.util.Map[K, V]](classOf[java.util.Map[K, V]], md) with fluentq.scala.MapExpression[K, V, Q] {
...
class ComparablePath[T <: Comparable[_]](t: Class[_ <: T], md: PathMetadata)
...
class NumberPath[T : Numeric](t: Class[T], md: PathMetadata)
...
class BooleanPath(md: PathMetadata)
...
class StringPath(md: PathMetadata)
...
class DatePath[T <: Comparable[_]](t: Class[_ <: T], md: PathMetadata)
...
class DateTimePath[T <: Comparable[_]](t: Class[_ <: T], md: PathMetadata)
...
class TimePath[T <: Comparable[_]](t: Class[_ <: T], md: PathMetadata)
...
class EnumPath[T <: Enum[T]](t: Class[_ <: T], md: PathMetadata)
