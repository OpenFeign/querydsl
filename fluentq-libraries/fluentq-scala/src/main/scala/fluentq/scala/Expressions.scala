...
import fluentq.core.types.Ops._
import fluentq.core.types._
import fluentq.scala.Constants._
import fluentq.scala.Operations._
...
trait CollectionExpressionBase[T <: Collection[C], C, Q <: Expression[_ >: C]]
  extends DslExpression[T] with fluentq.core.types.CollectionExpression[T,C] {
...
trait MapExpression[K, V, Q <: Expression[_ >: V]]
  extends DslExpression[java.util.Map[K, V]] with fluentq.core.types.MapExpression[K,V] {
