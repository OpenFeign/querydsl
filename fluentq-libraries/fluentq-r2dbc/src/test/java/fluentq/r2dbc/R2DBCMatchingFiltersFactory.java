...
import fluentq.core.NumberConstant;
import fluentq.core.StringConstant;
...
public class R2DBCMatchingFiltersFactory {
  ...
  public R2DBCMatchingFiltersFactory(FluentQModule module, Target target) {
    this.module = module;
    this.target = target;
  }
  ...
  public Collection<Predicate> date(
    ...
    if (!target.equals(Target.DERBY)
        ...
        && (!target.equals(Target.POSTGRESQL) || !module.equals(FluentQModule.JPA))) {
  ...
  public Collection<Predicate> string(StringExpression expr, StringExpression other) {
    ...
    if (!module.equals(FluentQModule.SQL)
        || (!target.equals(Target.HSQLDB)
            && !target.equals(Target.FIREBIRD)
