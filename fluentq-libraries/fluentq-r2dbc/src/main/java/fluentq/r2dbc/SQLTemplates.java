 ...
 * database specific Dialect for FluentQ SQL
 *
 * @author mc_fish
 */
public class SQLTemplates extends Templates {
  ...
  protected SQLTemplates(
      String quoteStr, char escape, boolean useQuotes, BindMarkersFactory bindMarkerFactory) {
  ...
  protected SQLTemplates(
      ...
      char escape,
      boolean useQuotes,
      BindMarkersFactory bindMarkerFactory) {
