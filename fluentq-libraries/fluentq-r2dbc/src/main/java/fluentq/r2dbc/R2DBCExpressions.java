...
import fluentq.sql.DatePart;
import fluentq.sql.RelationalPath;
import fluentq.sql.SQLOps;
import fluentq.sql.WindowOver;
import fluentq.sql.WithinGroup;
...
public final class R2DBCExpressions {
  ...
  /**
   * Create a new detached R2DBCQuery instance with the given projection
   *
   * @param expr projection
   * @param <T>
   * @return select(expr)
   */
  public static <T> R2DBCQuery<T> select(Expression<T> expr) {
    return new R2DBCQuery<Void>().select(expr);
  }
   ...
   * @return select(exprs)
   */
  public static R2DBCQuery<Tuple> select(Expression<?>... exprs) {
    return new R2DBCQuery<Void>().select(exprs);
  }
   ...
   */
  public static <T> R2DBCQuery<T> selectDistinct(Expression<T> expr) {
    return new R2DBCQuery<Void>().select(expr).distinct();
  }
   ...
   */
  public static R2DBCQuery<Tuple> selectDistinct(Expression<?>... exprs) {
    return new R2DBCQuery<Void>().select(exprs).distinct();
  }

  /**
   * Create a new detached R2DBCQuery instance with zero as the projection
   *
   * @return select(0)
   */
  public static R2DBCQuery<Integer> selectZero() {
    return select(Expressions.ZERO);
  }

  /**
   * Create a new detached R2DBCQuery instance with one as the projection
   *
   * @return select(1)
   */
  public static R2DBCQuery<Integer> selectOne() {
   ...
   */
  public static <T> R2DBCQuery<T> selectFrom(RelationalPath<T> expr) {
    return select(expr).from(expr);
  }
  ...
  public static <T> Union<T> union(SubQueryExpression<T>... sq) {
    return new R2DBCQuery<Void>().union(sq);
  }
  ...
  public static <T> Union<T> unionAll(SubQueryExpression<T>... sq) {
    return new R2DBCQuery<Void>().unionAll(sq);
  }
   ...
   *
   * <p>Returns the next value from the give sequence
   *
   ...
   *
   * <p>Returns the next value from the given sequence
   *
   ...
   * @return date
   */
  public static <D extends Comparable> DateExpression<D> date(
      Class<D> type, DateTimeExpression<?> dateTime) {
   ...
   */
  public static <D extends Comparable> DateTimeExpression<D> dateadd(
      DatePart unit, DateTimeExpression<D> date, int amount) {
   ...
   * @return converted date
   */
  public static <D extends Comparable> DateExpression<D> dateadd(
      DatePart unit, DateExpression<D> date, int amount) {
   ...
   */
  public static <D extends Comparable> NumberExpression<Integer> datediff(
      DatePart unit, DateExpression<D> start, DateExpression<D> end) {
   ...
   */
  public static <D extends Comparable> NumberExpression<Integer> datediff(
      DatePart unit, D start, DateExpression<D> end) {
    return Expressions.numberOperation(
        Integer.class, DATE_DIFF_OPS.get(unit), ConstantImpl.create(start), end);
  }
   ...
   */
  public static <D extends Comparable> NumberExpression<Integer> datediff(
      DatePart unit, DateExpression<D> start, D end) {
    return Expressions.numberOperation(
        Integer.class, DATE_DIFF_OPS.get(unit), start, ConstantImpl.create(end));
  }
   ...
   */
  public static <D extends Comparable> NumberExpression<Integer> datediff(
      DatePart unit, DateTimeExpression<D> start, DateTimeExpression<D> end) {
    return Expressions.numberOperation(Integer.class, DATE_DIFF_OPS.get(unit), start, end);
  }
   ...
   */
  public static <D extends Comparable> NumberExpression<Integer> datediff(
      DatePart unit, D start, DateTimeExpression<D> end) {
    return Expressions.numberOperation(
        Integer.class, DATE_DIFF_OPS.get(unit), ConstantImpl.create(start), end);
  }
   ...
   */
  public static <D extends Comparable> NumberExpression<Integer> datediff(
      DatePart unit, DateTimeExpression<D> start, D end) {
    return Expressions.numberOperation(
        Integer.class, DATE_DIFF_OPS.get(unit), start, ConstantImpl.create(end));
  }
   ...
   */
  public static <D extends Comparable> DateExpression<D> datetrunc(
      DatePart unit, DateExpression<D> expr) {
   ...
   */
  public static <D extends Comparable> DateTimeExpression<D> datetrunc(
      DatePart unit, DateTimeExpression<D> expr) {
   ...
   */
  public static <D extends Comparable> DateTimeExpression<D> addYears(
      DateTimeExpression<D> date, int years) {
    return Expressions.dateTimeOperation(
        date.getType(), Ops.DateTimeOps.ADD_YEARS, date, ConstantImpl.create(years));
  }
   ...
   * @return converted datetime
   */
  public static <D extends Comparable> DateTimeExpression<D> addMonths(
      DateTimeExpression<D> date, int months) {
    return Expressions.dateTimeOperation(
        date.getType(), Ops.DateTimeOps.ADD_MONTHS, date, ConstantImpl.create(months));
  }
   ...
   * @return converted date
   */
  public static <D extends Comparable> DateTimeExpression<D> addWeeks(
      DateTimeExpression<D> date, int weeks) {
    return Expressions.dateTimeOperation(
        date.getType(), Ops.DateTimeOps.ADD_WEEKS, date, ConstantImpl.create(weeks));
  }
   ...
   * @return converted datetime
   */
  public static <D extends Comparable> DateTimeExpression<D> addDays(
      DateTimeExpression<D> date, int days) {
    return Expressions.dateTimeOperation(
        date.getType(), Ops.DateTimeOps.ADD_DAYS, date, ConstantImpl.create(days));
  }
   ...
   * @return converted datetime
   */
  public static <D extends Comparable> DateTimeExpression<D> addHours(
      DateTimeExpression<D> date, int hours) {
    return Expressions.dateTimeOperation(
        date.getType(), Ops.DateTimeOps.ADD_HOURS, date, ConstantImpl.create(hours));
  }
   ...
   * @return converted datetime
   */
  public static <D extends Comparable> DateTimeExpression<D> addMinutes(
      DateTimeExpression<D> date, int minutes) {
    return Expressions.dateTimeOperation(
        date.getType(), Ops.DateTimeOps.ADD_MINUTES, date, ConstantImpl.create(minutes));
  }
   ...
   * @return converted datetime
   */
  public static <D extends Comparable> DateTimeExpression<D> addSeconds(
      DateTimeExpression<D> date, int seconds) {
    return Expressions.dateTimeOperation(
        date.getType(), Ops.DateTimeOps.ADD_SECONDS, date, ConstantImpl.create(seconds));
  }
   ...
   * @return converted date
   */
  public static <D extends Comparable> DateExpression<D> addYears(
      DateExpression<D> date, int years) {
    return Expressions.dateOperation(
        date.getType(), Ops.DateTimeOps.ADD_YEARS, date, ConstantImpl.create(years));
  }
   ...
   * @return converted date
   */
  public static <D extends Comparable> DateExpression<D> addMonths(
      DateExpression<D> date, int months) {
    return Expressions.dateOperation(
        date.getType(), Ops.DateTimeOps.ADD_MONTHS, date, ConstantImpl.create(months));
  }
   ...
   * @return converted date
   */
  public static <D extends Comparable> DateExpression<D> addWeeks(
      DateExpression<D> date, int weeks) {
    return Expressions.dateOperation(
        date.getType(), Ops.DateTimeOps.ADD_WEEKS, date, ConstantImpl.create(weeks));
  }
   ...
   * the function must all evaluate to constant expressions within each aggregate group, because
   * they identify a single row within each group. The constant argument expressions and the
   * expressions in the order_by_clause of the aggregate match by position. Therefore, the number of
   ...
   * aggregate. The arguments of the function identify a single hypothetical row within each
   * aggregate group. Therefore, they must all evaluate to constant expressions within each
   * aggregate group. The constant argument expressions and the expressions in the ORDER BY clause
   * of the aggregate match by position. Therefore the number of arguments must be the same and
   ...
   * It takes a percentile value and a sort specification and returns an element from the set. Nulls
   * are ignored in the calculation.
   *
   * <p>This function takes as an argument any numeric datatype or any nonnumeric datatype that can
  ...
  /**
   * REGR_R2 returns the coefficient of determination (also called R-squared or goodness of fit) for
   * the regression.
   *
   * @param arg1 first arg
   * @param arg2 second arg
   ...
   *
   * <p>{@code REGR_COUNT(arg1, arg2) * VAR_POP(arg2)}
   *
   * @param arg1 first arg
   * @param arg2 second arg
   ...
   *
   * <p>{@code REGR_COUNT(arg1, arg2) * VAR_POP(arg1)}
   *
   * @param arg1 first arg
   * @param arg2 second arg
   ...
   *
   * <p>REGR_COUNT(arg1, arg2) * COVAR_POP(arg1, arg2)
   *
   * @param arg1 first arg
   * @param arg2 second arg
   ...
   * and the expressions in the ORDER BY clause of the aggregate match by position. Therefore, the
   * number of arguments must be the same and their types must be compatible.
   *
   * @param args arguments
  ...
  /**
   * computes the ratio of a value to the sum of a set of values. If expr evaluates to null, then
   * the ratio-to-report value also evaluates to null.
   *
  ...
  /**
   * returns the population standard deviation and returns the square root of the population
   * variance.
   *
   * @param expr argument
  ...
  /**
   * returns the cumulative sample standard deviation and returns the square root of the sample
   * variance.
   *
   * @param expr argument
