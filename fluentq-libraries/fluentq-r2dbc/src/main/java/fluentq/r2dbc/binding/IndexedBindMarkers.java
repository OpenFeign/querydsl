package fluentq.r2dbc.binding;

import java.util.concurrent.atomic.AtomicIntegerFieldUpdater;

/**
 * Index-based bind marker. This implementation creates indexed bind markers using a numeric index
 * and an optional prefix for bind markers to be represented within the query string.
 *
 * @author Mark Paluch
