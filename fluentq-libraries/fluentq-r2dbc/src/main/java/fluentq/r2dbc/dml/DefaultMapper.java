...
import fluentq.sql.dml.AbstractMapper;
...
/**
 * Creates the mapping by inspecting the RelationalPath and Object via reflection. Given bean
 * doesn't need to have @Column metadata, but the fields need to have the same name as in the given
 * relational path.
 *
 * @author mc_fish
 */
