...
import com.querydsl.core.dml.mutiny.MutinyInsertClause;
 ...
 * @author tiwe
 */
public class HibernateInsertClause implements MutinyInsertClause<HibernateInsertClause> {
  ...
  public HibernateInsertClause(Mutiny.Session session, EntityPath<?> entity) {
    this(new DefaultSessionHolder(session), entity, HQLTemplates.DEFAULT);
  }

  public HibernateInsertClause(Mutiny.StatelessSession session, EntityPath<?> entity) {
