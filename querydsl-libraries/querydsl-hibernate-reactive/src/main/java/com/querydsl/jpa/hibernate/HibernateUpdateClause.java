...
import com.querydsl.core.dml.mutiny.MutinyUpdateClause;
 ...
 * @author tiwe
 */
public class HibernateUpdateClause implements MutinyUpdateClause<HibernateUpdateClause> {
  ...
  public HibernateUpdateClause(Mutiny.Session session, EntityPath<?> entity) {
    this(new DefaultSessionHolder(session), entity, HQLTemplates.DEFAULT);
  }

  public HibernateUpdateClause(Mutiny.StatelessSession session, EntityPath<?> entity) {
    this(new StatelessSessionHolder(session), entity, HQLTemplates.DEFAULT);
  }

  public HibernateUpdateClause(
