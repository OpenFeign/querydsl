 ...
 * @param <Q>
 */
public abstract class MutinyFetchableSubQueryBase<T, Q extends MutinyFetchableSubQueryBase<T, Q>>
    extends MutinyFetchableQueryBase<T, Q> implements ExtendedSubQuery<T> {

  private final SubQueryExpression<T> mixin;

  @SuppressWarnings("unchecked")
  public MutinyFetchableSubQueryBase(QueryMixin<Q> queryMixin) {
    super(queryMixin);
