...
class QuerydslAnnotationProcessorCompileTest {
  ...
  @Test
  void circularReferenceThroughDisabledDefaultVariable_producesWarning() {
  ...
  @Test
  void circularReferenceWithGloballyDisabledDefaultVariable_noWarning() {
    JavaFileObject orderSource =
        JavaFileObjects.forSourceString(
            "test.Order",
            """
    ...
    Compilation compilation =
        javac()
            .withProcessors(new QuerydslAnnotationProcessor())
            .withOptions("-Aquerydsl.createDefaultVariable=false")
            .compile(orderSource, customerSource);
  ...
  @Test
  void circularReferenceWithOneSideDisabledDefaultVariable_noWarning() {
    JavaFileObject orderSource =
        JavaFileObjects.forSourceString(
            "test.Order",
            """
