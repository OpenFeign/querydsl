...
/**
 * Details of a person. Represents a subset of the information available from Person, and so can be
 * used as a ResultClass for SQL/JDOQL queries.
 *
...
public class PersonalDetails {
  ...
  public String toString() {
    return "PersonalDetails : " + firstName + " " + lastName + " [age=" + age + "]";
  }
}
