...
public class ContainerTest extends AbstractTest {
  ...
  public void notContainsValuesInMapFields() {
    ...
    assertEquals(
        "SELECT FROM com.querydsl.jdo.models.fitness.Gym WHERE !this.wardrobes.containsValue(a1) &&"
            + " !this.wardrobes.containsValue(a2) PARAMETERS"
            + " com.querydsl.jdo.models.fitness.Wardrobe a1,"
            + " com.querydsl.jdo.models.fitness.Wardrobe a2",
        serialize(
            selectFrom(gym)
                .where(
    ...
    assertEquals(
        "SELECT FROM com.querydsl.jdo.models.fitness.Gym WHERE !this.wardrobes.containsValue(a1) &&"
            + " !this.wardrobes.containsValue(a2) && this.wardrobes.containsValue(a3) PARAMETERS"
            + " com.querydsl.jdo.models.fitness.Wardrobe a1,"
            + " com.querydsl.jdo.models.fitness.Wardrobe a2,"
            + " com.querydsl.jdo.models.fitness.Wardrobe a3",
        serialize(
            selectFrom(gym)
                .where(
                    gym.wardrobes.containsValue(wrd).not(),
  ...
  public void notContainsKeysInMapFields() {
    ...
    // wrd,org.jpox.samples.models.fitness.Wardrobe wrd2");
    assertEquals(
        "SELECT FROM com.querydsl.jdo.models.fitness.Gym WHERE !this.wardrobes2.containsKey(a1) &&"
            + " !this.wardrobes2.containsKey(a2) PARAMETERS"
            + " com.querydsl.jdo.models.fitness.Wardrobe a1,"
            + " com.querydsl.jdo.models.fitness.Wardrobe a2",
        serialize(
            selectFrom(gym)
    ...
    assertEquals(
        "SELECT FROM com.querydsl.jdo.models.fitness.Gym WHERE !this.wardrobes2.containsKey(a1) &&"
            + " !this.wardrobes2.containsKey(a2) && this.wardrobes2.containsKey(a3) PARAMETERS"
            + " com.querydsl.jdo.models.fitness.Wardrobe a1,"
            + " com.querydsl.jdo.models.fitness.Wardrobe a2,"
            + " com.querydsl.jdo.models.fitness.Wardrobe a3",
        serialize(
