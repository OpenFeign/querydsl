...
public abstract class AbstractJDOQuery<T, Q extends AbstractJDOQuery<T, Q>>
    extends FetchableSubQueryBase<T, Q> implements JDOQLQuery<T> {
  ...
  @Nullable private final PersistenceManager persistenceManager;
  ...
  @Nullable private FactoryExpression<?> projection;
  ...
  /**
   * Set the maximum fetch depth when fetching. A value of 0 has no meaning and will throw a {@link
