...
import io.github.openfeign.querydsl.jpa.spring.repository.Query;
...
public class LdapQueryMethod extends QueryMethod {
   ...
   * io.github.openfeign.querydsl.jpa.spring.repository.Query}.
   *
   * @return <code>true</code> if the target method is annotated with {@link
   *     io.github.openfeign.querydsl.jpa.spring.repository.Query}, <code>false</code> otherwise.
   */
  ...
  /**
   * Get the {@link io.github.openfeign.querydsl.jpa.spring.repository.Query} annotation of the
   * target method (if any).
   *
   * @return the {@link io.github.openfeign.querydsl.jpa.spring.repository.Query} annotation of the
   *     target method if present, or <code>null</code> otherwise.
   */
  @Nullable
  ...
  /**
   * Get the required {@link io.github.openfeign.querydsl.jpa.spring.repository.Query} annotation of
   * the target method.
   *
   * @return the {@link io.github.openfeign.querydsl.jpa.spring.repository.Query} annotation of the
   *     target method if present, or {@link IllegalStateException} otherwise.
   */
