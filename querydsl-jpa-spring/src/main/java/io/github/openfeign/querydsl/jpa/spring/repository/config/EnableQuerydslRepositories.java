...
/**
 * Annotation to enable Querydsl repositories.
 *
...
@Inherited
@Import(QuerydslRepositoriesRegistrar.class)
public @interface EnableQuerydslRepositories {
   ...
   * {@literal Impl}. So for a repository named {@code UserRepository} the corresponding
   * implementation class will be looked up scanning for {@code UserRepositoryImpl}.
   */
  String repositoryImplementationPostfix() default "Impl";

  /**
   * Configures the location of where to find the Spring Data named queries properties file. Will
   * default to {@code META-INF/Querydsl-named-queries.properties}.
   */
   ...
   * {@link QuerydslRepositoryFactoryBean}.
   */
  Class<?> repositoryFactoryBeanClass() default QuerydslRepositoryFactoryBean.class;
  ...
  /**
   * Configures the name of the {@link QuerydslTemplate} bean to be used with the repositories
   * detected. Defaults to {@link DefaultBeanNames#DATA_TEMPLATE}
   */
  String QuerydslTemplateRef() default "QuerydslTemplate";
