...
/**
 * Annotation to activate Ldap repositories. If no base package is configured through either {@link
 * #value()}, {@link #basePackages()} or {@link #basePackageClasses()} it will trigger scanning of
 * the package of annotated class.
 *
...
public @interface EnableLdapRepositories {
   ...
   * default to {@code META-INFO/ldap-named-queries.properties}.
   *
   * @return
   */
  ...
  /**
   * Returns the key of the {@link org.springframework.data.repository.query.QueryLookupStrategy} to
   * be used for lookup queries for query methods. Defaults to {@link
  ...
  /**
   * Configures the name of the {@link org.springframework.ldap.core.LdapTemplate} bean to be used
