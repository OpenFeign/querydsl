...
public class QuerydslLdapQuery<K> implements FilteredClause<QuerydslLdapQuery<K>> {
  ...
  private QueryMixin<QuerydslLdapQuery<K>> queryMixin =
      new QueryMixin<>(this, new DefaultQueryMetadata().noValidate());
  ...
  public QuerydslLdapQuery(
    ...
    this.filterGenerator =
        new LdapSerializer(ldapOperations.getObjectDirectoryMapper(), this.entityType);
  }
