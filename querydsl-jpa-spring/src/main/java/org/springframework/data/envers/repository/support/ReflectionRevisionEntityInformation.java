...
/**
 * {@link RevisionEntityInformation} that uses reflection to inspect a property annotated with
 * {@link RevisionNumber} to find out about the revision number type.
 *
...
public class ReflectionRevisionEntityInformation implements RevisionEntityInformation {
  ...
  /**
   * Creates a new {@link ReflectionRevisionEntityInformation} inspecting the given revision entity
   * class.
   *
  ...
  public ReflectionRevisionEntityInformation(Class<?> revisionEntityClass) {
    ...
    AnnotationDetectionFieldCallback fieldCallback =
        new AnnotationDetectionFieldCallback(RevisionNumber.class);
