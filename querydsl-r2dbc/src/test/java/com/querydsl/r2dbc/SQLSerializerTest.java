...
public class SQLSerializerTest {
  ...
  public void innerJoinWithoutCodeGeneration() {
    ...
    assertEquals(
        "select d.id from customer as c inner join department as d", r2DBCQuery.toString());
  }
  ...
  public void noSchemaInWhere() {
    ...
    R2DBCDeleteClause delete =
        new R2DBCDeleteClause(EasyMock.createNiceMock(Connection.class), defaultWithPrintSchema, e);
