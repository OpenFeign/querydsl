...
public class SQLSerializerTest {
  ...
  public void noSchemaInWhere() {
    ...
    SQLDeleteClause delete =
        new SQLDeleteClause(EasyMock.createNiceMock(Connection.class), defaultWithPrintSchema, e);
  ...
  public void schemaInWhere() {
    ...
    QEmployee e = QEmployee.employee;
    SQLDeleteClause delete =
        new SQLDeleteClause(EasyMock.createNiceMock(Connection.class), derbyWithPrintSchema, e);
    delete.where(e.id.gt(100));
