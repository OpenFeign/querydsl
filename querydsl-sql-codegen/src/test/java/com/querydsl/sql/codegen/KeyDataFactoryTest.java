...
public class KeyDataFactoryTest extends AbstractJDBCTest {
  ...
  public void test() throws SQLException {
    ...
    statement.execute(
        "create table employee(id INT, superior_id int, superior_id2 int, survey_id int,"
            + " survey_name varchar(30), CONSTRAINT PK_employee PRIMARY KEY (id), CONSTRAINT"
            + " FK_survey FOREIGN KEY (survey_id, survey_name) REFERENCES survey(id,name),"
