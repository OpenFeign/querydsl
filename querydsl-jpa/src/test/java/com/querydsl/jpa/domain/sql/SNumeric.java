...
public class SNumeric extends com.querydsl.sql.RelationalPathBase<SNumeric> {
  ...
  public final NumberPath<java.math.BigDecimal> value =
      createNumber("value", java.math.BigDecimal.class);

  public final NumberPath<java.math.BigDecimal> value_ =
      createNumber("value_", java.math.BigDecimal.class);
  ...
  public void addMetadata() {
    ...
    addMetadata(
        value, ColumnMetadata.named("value").withIndex(2).ofType(3).withSize(19).withDigits(2));
    addMetadata(
        value_, ColumnMetadata.named("value_").withIndex(3).ofType(3).withSize(19).withDigits(2));
  }
}
