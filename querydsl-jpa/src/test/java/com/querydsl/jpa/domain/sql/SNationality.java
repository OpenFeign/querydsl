...
public class SNationality extends com.querydsl.sql.RelationalPathBase<SNationality> {
  ...
  public final com.querydsl.sql.ForeignKey<SCalendar> fkab8efa23591ebbc =
      createForeignKey(calendarId, "id");

  public final com.querydsl.sql.ForeignKey<SPerson> _fkd78fcfaaf6578e38 =
  ...
  public void addMetadata() {
    addMetadata(
        calendarId, ColumnMetadata.named("calendar_id").withIndex(2).ofType(4).withSize(10));
