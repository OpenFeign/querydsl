...
public class SUserprop_categoryprop
    extends com.querydsl.sql.RelationalPathBase<SUserprop_categoryprop> {

  private static final long serialVersionUID = -190294914;

  public static final SUserprop_categoryprop userprop_categoryprop_ =
      new SUserprop_categoryprop("userprop__categoryprop_");
  ...
  public final com.querydsl.sql.PrimaryKey<SUserprop_categoryprop> primary =
      createPrimaryKey(propertiesId, userprop_id);

  public final com.querydsl.sql.ForeignKey<SCategoryprop> fke0fdb7d0fd94cd90 =
      createForeignKey(propertiesId, "id");

  public final com.querydsl.sql.ForeignKey<SUserprop> fke0fdb7d0904c19df =
      createForeignKey(userprop_id, "id");
  ...
  public void addMetadata() {
    ...
    addMetadata(
        userprop_id,
        ColumnMetadata.named("userprop__id").withIndex(1).ofType(-5).withSize(19).notNull());
  }
}
