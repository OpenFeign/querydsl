...
public class SCatalog_price extends com.querydsl.sql.RelationalPathBase<SCatalog_price> {
  ...
  public final com.querydsl.sql.PrimaryKey<SCatalog_price> primary =
      createPrimaryKey(catalog_id, pricesId);

  public final com.querydsl.sql.ForeignKey<SCatalog> fkaa04532fbb9021ab =
      createForeignKey(catalog_id, "id");

  public final com.querydsl.sql.ForeignKey<SPrice> fkaa04532f5222eaf7 =
  ...
  public void addMetadata() {
    addMetadata(
        catalog_id,
        ColumnMetadata.named("catalog__id").withIndex(1).ofType(4).withSize(10).notNull());
    addMetadata(
        pricesId, ColumnMetadata.named("prices_id").withIndex(2).ofType(-5).withSize(19).notNull());
  }
}
