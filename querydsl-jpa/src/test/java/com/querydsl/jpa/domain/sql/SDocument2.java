...
public class SDocument2 extends com.querydsl.sql.RelationalPathBase<SDocument2> {
  ...
  public void addMetadata() {
    addMetadata(
        createdBy, ColumnMetadata.named("createdBy").withIndex(2).ofType(8).withSize(22).notNull());
    addMetadata(
        creationDate, ColumnMetadata.named("creationDate").withIndex(3).ofType(93).withSize(19));
    addMetadata(
        deletedBy, ColumnMetadata.named("deletedBy").withIndex(4).ofType(8).withSize(22).notNull());
    addMetadata(
        deletedDate, ColumnMetadata.named("deletedDate").withIndex(5).ofType(93).withSize(19));
    addMetadata(
        documentBody, ColumnMetadata.named("documentBody").withIndex(6).ofType(12).withSize(255));
    addMetadata(
        documentStatus,
        ColumnMetadata.named("documentStatus").withIndex(7).ofType(8).withSize(22).notNull());
    addMetadata(
        documentSummary,
        ColumnMetadata.named("documentSummary").withIndex(8).ofType(12).withSize(255));
    addMetadata(
        documentTitle, ColumnMetadata.named("documentTitle").withIndex(9).ofType(12).withSize(255));
    addMetadata(
        documentVersion,
        ColumnMetadata.named("documentVersion").withIndex(10).ofType(8).withSize(22).notNull());
    addMetadata(
        entryId, ColumnMetadata.named("entryId").withIndex(11).ofType(8).withSize(22).notNull());
    addMetadata(id, ColumnMetadata.named("id").withIndex(1).ofType(-5).withSize(19).notNull());
    addMetadata(
        modificationDate,
        ColumnMetadata.named("modificationDate").withIndex(12).ofType(93).withSize(19));
    addMetadata(
        modifiedBy,
        ColumnMetadata.named("modifiedBy").withIndex(13).ofType(8).withSize(22).notNull());
  }
}
