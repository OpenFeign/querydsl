...
public class SCategoryprop extends com.querydsl.sql.RelationalPathBase<SCategoryprop> {
  ...
  public final com.querydsl.sql.ForeignKey<SUserprop_categoryprop> _fke0fdb7d0fd94cd90 =
      createInvForeignKey(id, "properties_id");

  public final com.querydsl.sql.ForeignKey<SCategory_categoryprop> _fk8543a280fd94cd90 =
      createInvForeignKey(id, "properties_id");
  ...
  public void addMetadata() {
    addMetadata(
        categoryId,
        ColumnMetadata.named("categoryId").withIndex(2).ofType(-5).withSize(19).notNull());
