...
public class SUser2_userprop extends com.querydsl.sql.RelationalPathBase<SUser2_userprop> {
  ...
  public final com.querydsl.sql.PrimaryKey<SUser2_userprop> primary =
      createPrimaryKey(propertiesId, user2_id);

  public final com.querydsl.sql.ForeignKey<SUser2> fk4611b46af21971a1 =
      createForeignKey(user2_id, "id");

  public final com.querydsl.sql.ForeignKey<SUserprop> fk4611b46aa56541dd =
  ...
  public void addMetadata() {
    ...
    addMetadata(
        user2_id, ColumnMetadata.named("user2__id").withIndex(1).ofType(-5).withSize(19).notNull());
  }
}
