...
public class SOrder extends com.querydsl.sql.RelationalPathBase<SOrder> {
  ...
  public final com.querydsl.sql.ForeignKey<SCustomer> fkc3df62d1b29c27bc =
      createForeignKey(customerId, "id");

  public final com.querydsl.sql.ForeignKey<SOrder_item> _fk1b5e8cbeb968f515 =
      createInvForeignKey(id, "order__id");

  public final com.querydsl.sql.ForeignKey<SCustomer> _fk600e7c419cc457f1 =
      createInvForeignKey(id, "currentOrder_id");

  public final com.querydsl.sql.ForeignKey<SOrderDeliveredItemIndices> _fk30cbd6611a4d2378 =
      createInvForeignKey(id, "Order_id");

  public final com.querydsl.sql.ForeignKey<SLineItems> _fkb2e400cb968f515 =
      createInvForeignKey(id, "order__id");
  ...
  public void addMetadata() {
    addMetadata(
        customerId, ColumnMetadata.named("customer_id").withIndex(3).ofType(4).withSize(10));
