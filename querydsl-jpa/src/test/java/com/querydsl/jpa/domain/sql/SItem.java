...
public class SItem extends com.querydsl.sql.RelationalPathBase<SItem> {
  ...
  public final com.querydsl.sql.ForeignKey<SStatus> fk5fde7acd23307bc =
      createForeignKey(statusId, "id");

  public final com.querydsl.sql.ForeignKey<SStatus> fk5fde7ac9ea26263 =
      createForeignKey(currentStatusId, "id");

  public final com.querydsl.sql.ForeignKey<SItem> fk5fde7ac2c7f0c58 =
      createForeignKey(productId, "id");

  public final com.querydsl.sql.ForeignKey<SAuditlog> _fkb88fbf6ae26109c =
      createInvForeignKey(id, "item_id");

  public final com.querydsl.sql.ForeignKey<SItem> _fk5fde7ac2c7f0c58 =
      createInvForeignKey(id, "product_id");

  public final com.querydsl.sql.ForeignKey<SOrder_item> _fk1b5e8cbe7640c8cf =
      createInvForeignKey(id, "items_id");

  public final com.querydsl.sql.ForeignKey<SPrice> _fkc59678362c7f0c58 =
      createInvForeignKey(id, "product_id");

  public final com.querydsl.sql.ForeignKey<SItem_statuschange> _fkcb99fb2aedc50192 =
      createInvForeignKey(id, "item__id");

  public final com.querydsl.sql.ForeignKey<SLineItems> _fkb2e400c3d8e44c3 =
  ...
  public void addMetadata() {
    addMetadata(
        currentStatusId,
        ColumnMetadata.named("currentStatus_id").withIndex(6).ofType(-5).withSize(19));
    addMetadata(
    ...
    addMetadata(
        paymentStatus, ColumnMetadata.named("paymentStatus").withIndex(3).ofType(4).withSize(10));
