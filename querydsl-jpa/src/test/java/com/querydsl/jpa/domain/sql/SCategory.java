...
public class SCategory extends com.querydsl.sql.RelationalPathBase<SCategory> {
  ...
  public final com.querydsl.sql.ForeignKey<SCategory_category> _fkc4e60b83561378ab =
      createInvForeignKey(id, "parentId");

  public final com.querydsl.sql.ForeignKey<SUserprop_category> _fk851f48d37ab543e8 =
      createInvForeignKey(id, "childCategories_id");

  public final com.querydsl.sql.ForeignKey<SCategory_categoryprop> _fk8543a2802974945f =
      createInvForeignKey(id, "category__id");

  public final com.querydsl.sql.ForeignKey<SCategory_category> _fkc4e60b833c83109d =
  ...
  public void addMetadata() {
    addMetadata(
        categoryDescription,
        ColumnMetadata.named("categoryDescription").withIndex(2).ofType(12).withSize(255));
    addMetadata(
        categoryName, ColumnMetadata.named("categoryName").withIndex(3).ofType(12).withSize(255));
    addMetadata(
        createdBy, ColumnMetadata.named("createdBy").withIndex(4).ofType(8).withSize(22).notNull());
    addMetadata(
        creationDate, ColumnMetadata.named("creationDate").withIndex(5).ofType(93).withSize(19));
    addMetadata(
        deleteDate, ColumnMetadata.named("deleteDate").withIndex(6).ofType(93).withSize(19));
    addMetadata(
        deletedBy, ColumnMetadata.named("deletedBy").withIndex(7).ofType(8).withSize(22).notNull());
    addMetadata(id, ColumnMetadata.named("id").withIndex(1).ofType(-5).withSize(19).notNull());
    addMetadata(
        modificationDate,
        ColumnMetadata.named("modificationDate").withIndex(8).ofType(93).withSize(19));
    addMetadata(
        modifiedBy,
        ColumnMetadata.named("modifiedBy").withIndex(9).ofType(8).withSize(22).notNull());
  }
}
