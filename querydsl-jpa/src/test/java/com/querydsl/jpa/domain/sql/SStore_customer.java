...
public class SStore_customer extends com.querydsl.sql.RelationalPathBase<SStore_customer> {
  ...
  public final com.querydsl.sql.ForeignKey<SStore> fk82ba2ce035d2d6bb =
      createForeignKey(store_id, "id");

  public final com.querydsl.sql.ForeignKey<SCustomer> fk82ba2ce051f3c3e5 =
  ...
  public void addMetadata() {
    addMetadata(
        customersId,
        ColumnMetadata.named("customers_id").withIndex(2).ofType(4).withSize(10).notNull());
    addMetadata(
        store_id, ColumnMetadata.named("store__id").withIndex(1).ofType(-5).withSize(19).notNull());
  }
}
