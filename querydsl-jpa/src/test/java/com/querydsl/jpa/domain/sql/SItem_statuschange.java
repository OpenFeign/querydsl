...
public class SItem_statuschange extends com.querydsl.sql.RelationalPathBase<SItem_statuschange> {
  ...
  public static final SItem_statuschange item_statuschange_ =
      new SItem_statuschange("item__statuschange_");
  ...
  public final com.querydsl.sql.ForeignKey<SStatuschange> fkcb99fb2ab2bd098d =
      createForeignKey(statusChangesId, "id");

  public final com.querydsl.sql.ForeignKey<SItem> fkcb99fb2aedc50192 =
      createForeignKey(item_id, "id");
  ...
  public void addMetadata() {
    addMetadata(
        item_id, ColumnMetadata.named("item__id").withIndex(1).ofType(-5).withSize(19).notNull());
    addMetadata(
        statusChangesId,
        ColumnMetadata.named("statusChanges_id").withIndex(2).ofType(-5).withSize(19).notNull());
  }
}
