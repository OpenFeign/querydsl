...
public class SWorldMammal extends com.querydsl.sql.RelationalPathBase<SWorldMammal> {
  ...
  public final com.querydsl.sql.ForeignKey<SMammal> fk4070aeece01c8ee7 =
      createForeignKey(mammalsId, "id");

  public final com.querydsl.sql.ForeignKey<SWorld> fk4070aeecd3538cf8 =
  ...
  public void addMetadata() {
    addMetadata(
        mammalsId,
        ColumnMetadata.named("mammals_id").withIndex(2).ofType(-5).withSize(19).notNull());
    addMetadata(
        worldId, ColumnMetadata.named("World_id").withIndex(1).ofType(-5).withSize(19).notNull());
  }
}
