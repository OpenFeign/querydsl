...
public class SCompany_department extends com.querydsl.sql.RelationalPathBase<SCompany_department> {
  ...
  public static final SCompany_department company_department_ =
      new SCompany_department("company__department_");
  ...
  public final com.querydsl.sql.ForeignKey<SDepartment> fk100ba6107d36c84d =
      createForeignKey(departmentsId, "id");

  public final com.querydsl.sql.ForeignKey<SCompany> fk100ba610f0d30873 =
      createForeignKey(company_id, "id");
  ...
  public void addMetadata() {
    addMetadata(
        company_id,
        ColumnMetadata.named("company__id").withIndex(1).ofType(4).withSize(10).notNull());
    addMetadata(
        departmentsId,
        ColumnMetadata.named("departments_id").withIndex(2).ofType(4).withSize(10).notNull());
  }
}
