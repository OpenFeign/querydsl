...
public class SEmployeeJobFunctions
  ...
  public final com.querydsl.sql.ForeignKey<SEmployee> fk49690e2f75b8f5bc =
  ...
  public void addMetadata() {
    addMetadata(
        employeeId,
        ColumnMetadata.named("Employee_id").withIndex(1).ofType(4).withSize(10).notNull());
    addMetadata(
        jobfunction, ColumnMetadata.named("jobfunction").withIndex(2).ofType(12).withSize(255));
  }
}
