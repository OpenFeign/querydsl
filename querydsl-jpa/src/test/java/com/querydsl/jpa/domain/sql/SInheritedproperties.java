...
public class SInheritedproperties
    extends com.querydsl.sql.RelationalPathBase<SInheritedproperties> {

  private static final long serialVersionUID = -992601885;

  public static final SInheritedproperties inheritedproperties_ =
      new SInheritedproperties("inheritedproperties_");
  ...
  public void addMetadata() {
    addMetadata(
        classProperty, ColumnMetadata.named("classProperty").withIndex(4).ofType(12).withSize(255));
    addMetadata(id, ColumnMetadata.named("id").withIndex(1).ofType(-5).withSize(19).notNull());
    addMetadata(
        stringAsSimple,
        ColumnMetadata.named("stringAsSimple").withIndex(2).ofType(12).withSize(255));
    addMetadata(
        superclassProperty,
        ColumnMetadata.named("superclassProperty").withIndex(3).ofType(12).withSize(255));
  }
}
