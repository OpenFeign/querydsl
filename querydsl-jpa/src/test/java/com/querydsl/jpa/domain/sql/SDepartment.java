...
public class SDepartment extends com.querydsl.sql.RelationalPathBase<SDepartment> {
  ...
  public final com.querydsl.sql.ForeignKey<SCompany> fk1f3a274ddc953998 =
      createForeignKey(companyId, "id");

  public final com.querydsl.sql.ForeignKey<SCompany_department> _fk100ba6107d36c84d =
      createInvForeignKey(id, "departments_id");

  public final com.querydsl.sql.ForeignKey<SDepartment_employee> _fkc33a14ff7d2db0e1 =
      createInvForeignKey(id, "department__id");
