...
public class SCatalog extends com.querydsl.sql.RelationalPathBase<SCatalog> {
  ...
  public final com.querydsl.sql.ForeignKey<SCatalog_price> _fkaa04532fbb9021ab =
  ...
  public void addMetadata() {
    addMetadata(
        effectiveDate, ColumnMetadata.named("effectiveDate").withIndex(2).ofType(91).withSize(10));
