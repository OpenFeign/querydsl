...
public class SUserprop extends com.querydsl.sql.RelationalPathBase<SUserprop> {
  ...
  public final com.querydsl.sql.ForeignKey<SUserprop_category> _fk851f48d3904c19df =
      createInvForeignKey(id, "userprop__id");

  public final com.querydsl.sql.ForeignKey<SUserprop_categoryprop> _fke0fdb7d0904c19df =
      createInvForeignKey(id, "userprop__id");

  public final com.querydsl.sql.ForeignKey<SUser2_userprop> _fk4611b46aa56541dd =
