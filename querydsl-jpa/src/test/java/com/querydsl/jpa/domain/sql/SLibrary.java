...
public class SLibrary extends com.querydsl.sql.RelationalPathBase<SLibrary> {
  ...
  public final com.querydsl.sql.ForeignKey<SBookversion> _fkef4bc070e364cd17 =
  ...
  public void addMetadata() {
    addMetadata(
        identity, ColumnMetadata.named("identity").withIndex(1).ofType(-5).withSize(19).notNull());
  }
}
