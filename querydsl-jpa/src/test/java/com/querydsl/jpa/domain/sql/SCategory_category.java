...
public class SCategory_category extends com.querydsl.sql.RelationalPathBase<SCategory_category> {
  ...
  public static final SCategory_category category_category_ =
      new SCategory_category("category__category_");

  public final NumberPath<Long> childId = createNumber("childId", Long.class);

  public final NumberPath<Long> parentId = createNumber("parentId", Long.class);

  public final com.querydsl.sql.PrimaryKey<SCategory_category> primary =
      createPrimaryKey(childId, parentId);

  public final com.querydsl.sql.ForeignKey<SCategory> fkc4e60b83561378ab =
      createForeignKey(parentId, "id");

  public final com.querydsl.sql.ForeignKey<SCategory> fkc4e60b833c83109d =
  ...
  public void addMetadata() {
    addMetadata(
        childId, ColumnMetadata.named("childId").withIndex(2).ofType(-5).withSize(19).notNull());
    addMetadata(
        parentId, ColumnMetadata.named("parentId").withIndex(1).ofType(-5).withSize(19).notNull());
  }
}
