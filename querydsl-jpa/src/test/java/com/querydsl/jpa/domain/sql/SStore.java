...
public class SStore extends com.querydsl.sql.RelationalPathBase<SStore> {
  ...
  public final com.querydsl.sql.ForeignKey<SLocation> fkcad4239e8a55845c =
      createForeignKey(locationId, "id");

  public final com.querydsl.sql.ForeignKey<SStore_customer> _fk82ba2ce035d2d6bb =
      createInvForeignKey(id, "store__id");
  ...
  public void addMetadata() {
    ...
    addMetadata(
        locationId, ColumnMetadata.named("location_id").withIndex(2).ofType(-5).withSize(19));
  }
}
