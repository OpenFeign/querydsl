...
public class SDepartment_employee
    extends com.querydsl.sql.RelationalPathBase<SDepartment_employee> {

  private static final long serialVersionUID = 1293706549;

  public static final SDepartment_employee department_employee_ =
      new SDepartment_employee("department__employee_");
  ...
  public final com.querydsl.sql.ForeignKey<SEmployee> fkc33a14ffd846a985 =
      createForeignKey(employeesId, "id");

  public final com.querydsl.sql.ForeignKey<SDepartment> fkc33a14ff7d2db0e1 =
      createForeignKey(department_id, "id");
  ...
  public void addMetadata() {
    addMetadata(
        department_id,
        ColumnMetadata.named("department__id").withIndex(1).ofType(4).withSize(10).notNull());
    addMetadata(
        employeesId,
        ColumnMetadata.named("employees_id").withIndex(2).ofType(4).withSize(10).notNull());
  }
}
