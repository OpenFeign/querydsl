...
public class SPerson extends com.querydsl.sql.RelationalPathBase<SPerson> {
  ...
  public final com.querydsl.sql.ForeignKey<SPersonid> fkd78fcfaad7999e61 =
      createForeignKey(pidId, "id");

  public final com.querydsl.sql.ForeignKey<SNationality> fkd78fcfaaf6578e38 =
      createForeignKey(nationalityId, "id");

  public final com.querydsl.sql.ForeignKey<SAccount> _fk809dbbd28cfac74 =
  ...
  public void addMetadata() {
    ...
    addMetadata(
        nationalityId, ColumnMetadata.named("nationality_id").withIndex(4).ofType(-5).withSize(19));
