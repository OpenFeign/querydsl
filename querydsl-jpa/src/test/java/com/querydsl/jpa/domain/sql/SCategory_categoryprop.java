...
public class SCategory_categoryprop
    extends com.querydsl.sql.RelationalPathBase<SCategory_categoryprop> {

  private static final long serialVersionUID = -1348316210;

  public static final SCategory_categoryprop category_categoryprop_ =
      new SCategory_categoryprop("category__categoryprop_");
  ...
  public final com.querydsl.sql.PrimaryKey<SCategory_categoryprop> primary =
      createPrimaryKey(category_id, propertiesId);

  public final com.querydsl.sql.ForeignKey<SCategoryprop> fk8543a280fd94cd90 =
      createForeignKey(propertiesId, "id");

  public final com.querydsl.sql.ForeignKey<SCategory> fk8543a2802974945f =
      createForeignKey(category_id, "id");
  ...
  public void addMetadata() {
    addMetadata(
        category_id,
        ColumnMetadata.named("category__id").withIndex(1).ofType(-5).withSize(19).notNull());
    addMetadata(
        propertiesId,
        ColumnMetadata.named("properties_id").withIndex(2).ofType(-5).withSize(19).notNull());
  }
}
