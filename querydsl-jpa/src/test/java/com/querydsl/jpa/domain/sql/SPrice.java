...
public class SPrice extends com.querydsl.sql.RelationalPathBase<SPrice> {
  ...
  public final com.querydsl.sql.ForeignKey<SItem> fkc59678362c7f0c58 =
      createForeignKey(productId, "id");

  public final com.querydsl.sql.ForeignKey<SCatalog_price> _fkaa04532f5222eaf7 =
  ...
  public void addMetadata() {
    addMetadata(
        amount, ColumnMetadata.named("amount").withIndex(2).ofType(-5).withSize(19).notNull());
