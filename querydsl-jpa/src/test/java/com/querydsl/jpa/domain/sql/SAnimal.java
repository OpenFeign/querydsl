...
public class SAnimal extends com.querydsl.sql.RelationalPathBase<SAnimal> {
  ...
  public final com.querydsl.sql.ForeignKey<SAnimal> fkccec31e312a37469 =
      createForeignKey(mateId, "id");

  public final com.querydsl.sql.ForeignKey<SKittens> _fkd60087cc3881aaa7 =
      createInvForeignKey(id, "kitten_id");

  public final com.querydsl.sql.ForeignKey<SAnimal> _fkccec31e312a37469 =
      createInvForeignKey(id, "mate_id");

  public final com.querydsl.sql.ForeignKey<SKittensSet> _fk4fccad6f8f00fdf8 =
      createInvForeignKey(id, "cat_id");

  public final com.querydsl.sql.ForeignKey<SKittens> _fkd60087cc8f00fdf8 =
      createInvForeignKey(id, "cat_id");

  public final com.querydsl.sql.ForeignKey<SKittensSet> _fk4fccad6f3881aaa7 =
      createInvForeignKey(id, "kitten_id");
  ...
  public void addMetadata() {
    ...
    addMetadata(
        bodyWeight,
        ColumnMetadata.named("bodyWeight").withIndex(5).ofType(8).withSize(22).notNull());
    ...
    addMetadata(
        floatProperty,
        ColumnMetadata.named("floatProperty").withIndex(8).ofType(7).withSize(12).notNull());
    ...
    addMetadata(
        weight, ColumnMetadata.named("weight").withIndex(12).ofType(4).withSize(10).notNull());
  }
}
