...
public class SCompany extends com.querydsl.sql.RelationalPathBase<SCompany> {
  ...
  public final com.querydsl.sql.ForeignKey<SEmployee> fkdc405382edf003bd =
      createForeignKey(ceoId, "id");

  public final com.querydsl.sql.ForeignKey<SEmployee> _fk9d39ef71dc953998 =
      createInvForeignKey(id, "company_id");

  public final com.querydsl.sql.ForeignKey<SUser> _fk6a68df4dc953998 =
      createInvForeignKey(id, "company_id");

  public final com.querydsl.sql.ForeignKey<SCompany_department> _fk100ba610f0d30873 =
      createInvForeignKey(id, "company__id");

  public final com.querydsl.sql.ForeignKey<SDepartment> _fk1f3a274ddc953998 =
      createInvForeignKey(id, "company_id");
  ...
  public void addMetadata() {
    ...
    addMetadata(
        ratingOrdinal, ColumnMetadata.named("ratingOrdinal").withIndex(3).ofType(4).withSize(10));
    addMetadata(
        ratingString, ColumnMetadata.named("ratingString").withIndex(4).ofType(12).withSize(255));
  }
}
