...
public class SBookversion extends com.querydsl.sql.RelationalPathBase<SBookversion> {
  ...
  public final com.querydsl.sql.PrimaryKey<SBookversion> primary =
      createPrimaryKey(bookIDIdentity, libraryIdentity);

  public final com.querydsl.sql.ForeignKey<SBookid> fkef4bc0704dd5d6c3 =
      createForeignKey(bookIDIdentity, "identity");

  public final com.querydsl.sql.ForeignKey<SLibrary> fkef4bc070e364cd17 =
      createForeignKey(libraryIdentity, "identity");

  public final com.querydsl.sql.ForeignKey<SBookBookmarks> _fk94026827e33d3be4 =
      createInvForeignKey(
          Arrays.asList(bookIDIdentity, libraryIdentity),
          Arrays.asList("BookVersion_bookID_identity", "BookVersion_library_identity"));
  ...
  public void addMetadata() {
    addMetadata(
        bookIDIdentity,
        ColumnMetadata.named("bookID_identity").withIndex(3).ofType(-5).withSize(19).notNull());
    addMetadata(
        description, ColumnMetadata.named("description").withIndex(1).ofType(12).withSize(255));
    addMetadata(
        libraryIdentity,
        ColumnMetadata.named("library_identity").withIndex(4).ofType(-5).withSize(19).notNull());
