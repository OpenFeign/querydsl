...
public class SBookBookmarks extends com.querydsl.sql.RelationalPathBase<SBookBookmarks> {
  ...
  public final NumberPath<Long> bookVersionBookIDIdentity =
      createNumber("bookVersionBookIDIdentity", Long.class);

  public final NumberPath<Long> bookVersionLibraryIdentity =
      createNumber("bookVersionLibraryIdentity", Long.class);

  public final StringPath comment = createString("comment");

  public final NumberPath<Long> page = createNumber("page", Long.class);

  public final com.querydsl.sql.PrimaryKey<SBookBookmarks> primary =
      createPrimaryKey(bookVersionBookIDIdentity, bookVersionLibraryIdentity, bookMarksORDER);

  public final com.querydsl.sql.ForeignKey<SBookversion> fk94026827e33d3be4 =
      createForeignKey(
          Arrays.asList(bookVersionBookIDIdentity, bookVersionLibraryIdentity),
  ...
  public void addMetadata() {
    addMetadata(
        bookMarksORDER,
        ColumnMetadata.named("bookMarks_ORDER").withIndex(5).ofType(4).withSize(10).notNull());
    addMetadata(
        bookVersionBookIDIdentity,
        ColumnMetadata.named("BookVersion_bookID_identity")
            .withIndex(1)
            .ofType(-5)
            .withSize(19)
            .notNull());
    addMetadata(
        bookVersionLibraryIdentity,
        ColumnMetadata.named("BookVersion_library_identity")
            .withIndex(2)
            .ofType(-5)
            .withSize(19)
            .notNull());
