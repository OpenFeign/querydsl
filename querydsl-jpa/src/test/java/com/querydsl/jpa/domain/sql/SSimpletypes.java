...
public class SSimpletypes extends com.querydsl.sql.RelationalPathBase<SSimpletypes> {
  ...
  public final NumberPath<java.math.BigDecimal> bigDecimal =
      createNumber("bigDecimal", java.math.BigDecimal.class);
  ...
  public void addMetadata() {
    ...
    addMetadata(
        bbyte2, ColumnMetadata.named("bbyte2").withIndex(3).ofType(-6).withSize(3).notNull());
    addMetadata(
        bigDecimal,
        ColumnMetadata.named("bigDecimal").withIndex(4).ofType(3).withSize(19).withDigits(2));
    addMetadata(cchar, ColumnMetadata.named("cchar").withIndex(5).ofType(1).withSize(1));
    addMetadata(
        cchar2, ColumnMetadata.named("cchar2").withIndex(6).ofType(1).withSize(1).notNull());
    ...
    addMetadata(
        ddouble2, ColumnMetadata.named("ddouble2").withIndex(9).ofType(8).withSize(22).notNull());
    addMetadata(ffloat, ColumnMetadata.named("ffloat").withIndex(10).ofType(7).withSize(12));
    addMetadata(
        ffloat2, ColumnMetadata.named("ffloat2").withIndex(11).ofType(7).withSize(12).notNull());
    ...
    addMetadata(
        iint2, ColumnMetadata.named("iint2").withIndex(13).ofType(4).withSize(10).notNull());
    ...
    addMetadata(
        llong2, ColumnMetadata.named("llong2").withIndex(16).ofType(-5).withSize(19).notNull());
