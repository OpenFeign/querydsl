...
public class SUser2 extends com.querydsl.sql.RelationalPathBase<SUser2> {
  ...
  public final com.querydsl.sql.ForeignKey<SUser2_userprop> _fk4611b46af21971a1 =
      createInvForeignKey(id, "user2__id");
  ...
  public void addMetadata() {
    ...
    addMetadata(
        deleteDate, ColumnMetadata.named("deleteDate").withIndex(4).ofType(93).withSize(19));
    addMetadata(
        deletedBy, ColumnMetadata.named("deletedBy").withIndex(5).ofType(8).withSize(22).notNull());
    addMetadata(id, ColumnMetadata.named("id").withIndex(1).ofType(-5).withSize(19).notNull());
    addMetadata(
        modificationDate,
        ColumnMetadata.named("modificationDate").withIndex(6).ofType(93).withSize(19));
    addMetadata(
        modifiedBy,
        ColumnMetadata.named("modifiedBy").withIndex(7).ofType(8).withSize(22).notNull());
    addMetadata(userEmail, ColumnMetadata.named("userEmail").withIndex(8).ofType(12).withSize(255));
    addMetadata(
        userFirstName, ColumnMetadata.named("userFirstName").withIndex(9).ofType(12).withSize(255));
    addMetadata(
        userLastName, ColumnMetadata.named("userLastName").withIndex(10).ofType(12).withSize(255));
    addMetadata(userName, ColumnMetadata.named("userName").withIndex(11).ofType(12).withSize(255));
    addMetadata(
        userPassword, ColumnMetadata.named("userPassword").withIndex(12).ofType(12).withSize(255));
  }
}
