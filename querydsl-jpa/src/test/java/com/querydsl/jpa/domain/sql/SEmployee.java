...
public class SEmployee extends com.querydsl.sql.RelationalPathBase<SEmployee> {
  ...
  public final com.querydsl.sql.ForeignKey<SCompany> fk9d39ef71dc953998 =
      createForeignKey(companyId, "id");

  public final com.querydsl.sql.ForeignKey<SUser> fk9d39ef712743b59c =
      createForeignKey(userId, "id");

  public final com.querydsl.sql.ForeignKey<SCompany> _fkdc405382edf003bd =
      createInvForeignKey(id, "ceo_id");

  public final com.querydsl.sql.ForeignKey<SEmployeeJobFunctions> _fk49690e2f75b8f5bc =
      createInvForeignKey(id, "Employee_id");

  public final com.querydsl.sql.ForeignKey<SDepartment_employee> _fkc33a14ffd846a985 =
