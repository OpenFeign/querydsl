...
public class SOrder_item extends com.querydsl.sql.RelationalPathBase<SOrder_item> {
  ...
  public final com.querydsl.sql.PrimaryKey<SOrder_item> primary =
      createPrimaryKey(_index, order_id);

  public final com.querydsl.sql.ForeignKey<SItem> fk1b5e8cbe7640c8cf =
      createForeignKey(itemsId, "id");

  public final com.querydsl.sql.ForeignKey<SOrder> fk1b5e8cbeb968f515 =
  ...
  public void addMetadata() {
    ...
    addMetadata(
        itemsId, ColumnMetadata.named("items_id").withIndex(2).ofType(-5).withSize(19).notNull());
    addMetadata(
