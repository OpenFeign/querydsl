...
public class SUserprop_category extends com.querydsl.sql.RelationalPathBase<SUserprop_category> {
  ...
  public static final SUserprop_category userprop_category_ =
      new SUserprop_category("userprop__category_");
  ...
  public final com.querydsl.sql.PrimaryKey<SUserprop_category> primary =
      createPrimaryKey(childCategoriesId, userprop_id);

  public final com.querydsl.sql.ForeignKey<SUserprop> fk851f48d3904c19df =
      createForeignKey(userprop_id, "id");

  public final com.querydsl.sql.ForeignKey<SCategory> fk851f48d37ab543e8 =
  ...
  public void addMetadata() {
    addMetadata(
        childCategoriesId,
        ColumnMetadata.named("childCategories_id").withIndex(2).ofType(-5).withSize(19).notNull());
    addMetadata(
        userprop_id,
