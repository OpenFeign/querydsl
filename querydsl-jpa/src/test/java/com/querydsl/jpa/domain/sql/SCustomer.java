...
public class SCustomer extends com.querydsl.sql.RelationalPathBase<SCustomer> {
  ...
  public final com.querydsl.sql.ForeignKey<SName> fk600e7c4196a83d9c =
      createForeignKey(nameId, "id");

  public final com.querydsl.sql.ForeignKey<SOrder> fk600e7c419cc457f1 =
      createForeignKey(currentOrderId, "id");

  public final com.querydsl.sql.ForeignKey<SStore_customer> _fk82ba2ce051f3c3e5 =
      createInvForeignKey(id, "customers_id");

  public final com.querydsl.sql.ForeignKey<SOrder> _fkc3df62d1b29c27bc =
  ...
  public void addMetadata() {
    addMetadata(
        currentOrderId,
        ColumnMetadata.named("currentOrder_id").withIndex(2).ofType(-5).withSize(19));
