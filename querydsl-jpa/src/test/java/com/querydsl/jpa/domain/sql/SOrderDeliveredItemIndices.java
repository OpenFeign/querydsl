...
public class SOrderDeliveredItemIndices
  ...
  public final com.querydsl.sql.PrimaryKey<SOrderDeliveredItemIndices> primary =
      createPrimaryKey(orderId, _index);

  public final com.querydsl.sql.ForeignKey<SOrder> fk30cbd6611a4d2378 =
      createForeignKey(orderId, "id");

  public SOrderDeliveredItemIndices(String variable) {
    super(
        SOrderDeliveredItemIndices.class, forVariable(variable), "", "Order_deliveredItemIndices");
    addMetadata();
  }
  ...
  public void addMetadata() {
    ...
    addMetadata(
        ...
        ColumnMetadata.named("deliveredItemIndices").withIndex(2).ofType(4).withSize(10));
    addMetadata(
        orderId, ColumnMetadata.named("Order_id").withIndex(1).ofType(-5).withSize(19).notNull());
  }
}
